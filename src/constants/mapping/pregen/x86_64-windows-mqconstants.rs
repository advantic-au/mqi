...
pub const MQCOMPRESS_CONST: LinearSource = ConstSource(&[(-1,"MQCOMPRESS_NOT_AVAILABLE"),(0,"MQCOMPRESS_NONE"),(1,"MQCOMPRESS_RLE"),(2,"MQCOMPRESS_ZLIBFAST"),(4,"MQCOMPRESS_ZLIBHIGH"),(8,"MQCOMPRESS_SYSTEM"),(268435455,"MQCOMPRESS_ANY"),], &[]);
...
pub const MQ_CERT_CONST: LinearSource = ConstSource(&[(0,"MQ_CERT_VAL_POLICY_ANY"),(1,"MQ_CERT_VAL_POLICY_RFC5280"),], &[(0,"MQ_CERT_VAL_POLICY_DEFAULT"),]);
