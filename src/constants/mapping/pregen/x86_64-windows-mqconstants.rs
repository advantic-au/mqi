...
pub const MQACT_CONST: LinearSource = ConstSource(&[(1,"MQACT_FORCE_REMOVE"),(2,"MQACT_ADVANCE_LOG"),(3,"MQACT_COLLECT_STATISTICS"),(4,"MQACT_PUBSUB"),(5,"MQACT_ADD"),(6,"MQACT_REPLACE"),(7,"MQACT_REMOVE"),(8,"MQACT_REMOVEALL"),(9,"MQACT_FAIL"),(10,"MQACT_REDUCE_LOG"),(11,"MQACT_ARCHIVE_LOG"),], &[]);
pub const MQADOPT_CHECK_CONST: LinearSource = ConstSource(&[(0,"MQADOPT_CHECK_NONE"),(1,"MQADOPT_CHECK_ALL"),(2,"MQADOPT_CHECK_Q_MGR_NAME"),(4,"MQADOPT_CHECK_NET_ADDR"),(8,"MQADOPT_CHECK_CHANNEL_NAME"),], &[]);
pub const MQADOPT_TYPE_CONST: LinearSource = ConstSource(&[(0,"MQADOPT_TYPE_NO"),(1,"MQADOPT_TYPE_ALL"),(2,"MQADOPT_TYPE_SVR"),(4,"MQADOPT_TYPE_SDR"),(8,"MQADOPT_TYPE_RCVR"),(16,"MQADOPT_TYPE_CLUSRCVR"),], &[]);
pub const MQADPCTX_CONST: LinearSource = ConstSource(&[(0,"MQADPCTX_NO"),(1,"MQADPCTX_YES"),], &[]);
pub const MQAIT_CONST: LinearSource = ConstSource(&[(0,"MQAIT_ALL"),(1,"MQAIT_CRL_LDAP"),(2,"MQAIT_OCSP"),(3,"MQAIT_IDPW_OS"),(4,"MQAIT_IDPW_LDAP"),], &[]);
pub const MQAPPL_CONST: LinearSource = ConstSource(&[(0,"MQAPPL_IMMOVABLE"),(1,"MQAPPL_MOVABLE"),], &[]);
pub const MQAS_CONST: LinearSource = ConstSource(&[(0,"MQAS_NONE"),(1,"MQAS_STARTED"),(2,"MQAS_START_WAIT"),(3,"MQAS_STOPPED"),(4,"MQAS_SUSPENDED"),(5,"MQAS_SUSPENDED_TEMPORARY"),(6,"MQAS_ACTIVE"),(7,"MQAS_INACTIVE"),], &[]);
pub const MQAT_CONST: LinearSource = ConstSource(&[(-1,"MQAT_UNKNOWN"),(0,"MQAT_NO_CONTEXT"),(1,"MQAT_CICS"),(2,"MQAT_ZOS"),(3,"MQAT_IMS"),(4,"MQAT_OS2"),(5,"MQAT_DOS"),(6,"MQAT_UNIX"),(7,"MQAT_QMGR"),(8,"MQAT_OS400"),(9,"MQAT_WINDOWS"),(10,"MQAT_CICS_VSE"),(11,"MQAT_WINDOWS_NT"),(12,"MQAT_VMS"),(13,"MQAT_NSK"),(14,"MQAT_VOS"),(15,"MQAT_OPEN_TP1"),(18,"MQAT_VM"),(19,"MQAT_IMS_BRIDGE"),(20,"MQAT_XCF"),(21,"MQAT_CICS_BRIDGE"),(22,"MQAT_NOTES_AGENT"),(23,"MQAT_TPF"),(25,"MQAT_USER"),(26,"MQAT_QMGR_PUBLISH"),(28,"MQAT_JAVA"),(29,"MQAT_DQM"),(30,"MQAT_CHANNEL_INITIATOR"),(31,"MQAT_WLM"),(32,"MQAT_BATCH"),(33,"MQAT_RRS_BATCH"),(34,"MQAT_SIB"),(35,"MQAT_SYSTEM_EXTENSION"),(36,"MQAT_MCAST_PUBLISH"),(37,"MQAT_AMQP"),], &[(2,"MQAT_MVS"),(2,"MQAT_OS390"),(6,"MQAT_AIX"),(11,"MQAT_DEFAULT"),(13,"MQAT_GUARDIAN"),(26,"MQAT_BROKER"),]);
pub const MQAUTHENTICATE_CONST: LinearSource = ConstSource(&[(0,"MQAUTHENTICATE_OS"),(1,"MQAUTHENTICATE_PAM"),], &[]);
pub const MQAUTHOPT_CONST: LinearSource = ConstSource(&[(1,"MQAUTHOPT_ENTITY_EXPLICIT"),(2,"MQAUTHOPT_ENTITY_SET"),(16,"MQAUTHOPT_NAME_EXPLICIT"),(32,"MQAUTHOPT_NAME_ALL_MATCHING"),(64,"MQAUTHOPT_NAME_AS_WILDCARD"),(256,"MQAUTHOPT_CUMULATIVE"),(512,"MQAUTHOPT_EXCLUDE_TEMP"),], &[]);
pub const MQAUTH_CONST: LinearSource = ConstSource(&[(-3,"MQAUTH_ALL_MQI"),(-2,"MQAUTH_ALL_ADMIN"),(-1,"MQAUTH_ALL"),(0,"MQAUTH_NONE"),(1,"MQAUTH_ALT_USER_AUTHORITY"),(2,"MQAUTH_BROWSE"),(3,"MQAUTH_CHANGE"),(4,"MQAUTH_CLEAR"),(5,"MQAUTH_CONNECT"),(6,"MQAUTH_CREATE"),(7,"MQAUTH_DELETE"),(8,"MQAUTH_DISPLAY"),(9,"MQAUTH_INPUT"),(10,"MQAUTH_INQUIRE"),(11,"MQAUTH_OUTPUT"),(12,"MQAUTH_PASS_ALL_CONTEXT"),(13,"MQAUTH_PASS_IDENTITY_CONTEXT"),(14,"MQAUTH_SET"),(15,"MQAUTH_SET_ALL_CONTEXT"),(16,"MQAUTH_SET_IDENTITY_CONTEXT"),(17,"MQAUTH_CONTROL"),(18,"MQAUTH_CONTROL_EXTENDED"),(19,"MQAUTH_PUBLISH"),(20,"MQAUTH_SUBSCRIBE"),(21,"MQAUTH_RESUME"),(22,"MQAUTH_SYSTEM"),], &[]);
pub const MQAUTOCLUS_CONST: LinearSource = ConstSource(&[(0,"MQAUTOCLUS_TYPE_NONE"),(1,"MQAUTOCLUS_TYPE_UNIFORM"),], &[]);
pub const MQAUTO_CONST: LinearSource = ConstSource(&[(0,"MQAUTO_START_NO"),(1,"MQAUTO_START_YES"),], &[]);
pub const MQBACF_CONST: LinearSource = ConstSource(&[(7001,"MQBACF_EVENT_ACCOUNTING_TOKEN"),(7002,"MQBACF_EVENT_SECURITY_ID"),(7003,"MQBACF_RESPONSE_SET"),(7004,"MQBACF_RESPONSE_ID"),(7005,"MQBACF_EXTERNAL_UOW_ID"),(7006,"MQBACF_CONNECTION_ID"),(7007,"MQBACF_GENERIC_CONNECTION_ID"),(7008,"MQBACF_ORIGIN_UOW_ID"),(7009,"MQBACF_Q_MGR_UOW_ID"),(7010,"MQBACF_ACCOUNTING_TOKEN"),(7011,"MQBACF_CORREL_ID"),(7012,"MQBACF_GROUP_ID"),(7013,"MQBACF_MSG_ID"),(7014,"MQBACF_CF_LEID"),(7015,"MQBACF_DESTINATION_CORREL_ID"),(7016,"MQBACF_SUB_ID"),(7019,"MQBACF_ALTERNATE_SECURITYID"),(7020,"MQBACF_MESSAGE_DATA"),(7021,"MQBACF_MQBO_STRUCT"),(7022,"MQBACF_MQCB_FUNCTION"),(7023,"MQBACF_MQCBC_STRUCT"),(7024,"MQBACF_MQCBD_STRUCT"),(7025,"MQBACF_MQCD_STRUCT"),(7026,"MQBACF_MQCNO_STRUCT"),(7027,"MQBACF_MQGMO_STRUCT"),(7028,"MQBACF_MQMD_STRUCT"),(7029,"MQBACF_MQPMO_STRUCT"),(7030,"MQBACF_MQSD_STRUCT"),(7031,"MQBACF_MQSTS_STRUCT"),(7032,"MQBACF_SUB_CORREL_ID"),(7033,"MQBACF_XA_XID"),(7034,"MQBACF_XQH_CORREL_ID"),(7035,"MQBACF_XQH_MSG_ID"),(7036,"MQBACF_REQUEST_ID"),(7037,"MQBACF_PROPERTIES_DATA"),(7038,"MQBACF_CONN_TAG"),(7039,"MQBACF_MQBNO_STRUCT"),], &[]);
pub const MQBALANCED_CONST: LinearSource = ConstSource(&[(0,"MQBALANCED_NO"),(1,"MQBALANCED_YES"),(2,"MQBALANCED_NOT_APPLICABLE"),(3,"MQBALANCED_UNKNOWN"),], &[]);
pub const MQBALSTATE_CONST: LinearSource = ConstSource(&[(0,"MQBALSTATE_NOT_APPLICABLE"),(1,"MQBALSTATE_LOW"),(2,"MQBALSTATE_OK"),(3,"MQBALSTATE_HIGH"),(4,"MQBALSTATE_UNKNOWN"),], &[]);
pub const MQBL_CONST: LinearSource = ConstSource(&[(-1,"MQBL_NULL_TERMINATED"),], &[]);
pub const MQBMHO_CONST: LinearSource = ConstSource(&[(0,"MQBMHO_NONE"),(1,"MQBMHO_DELETE_PROPERTIES"),], &[]);
pub const MQBND_CONST: LinearSource = ConstSource(&[(0,"MQBND_BIND_ON_OPEN"),(1,"MQBND_BIND_NOT_FIXED"),(2,"MQBND_BIND_ON_GROUP"),], &[]);
pub const MQBNO_BALTYPE_CONST: LinearSource = ConstSource(&[(0,"MQBNO_BALTYPE_SIMPLE"),(1,"MQBNO_BALTYPE_REQREP"),(65536,"MQBNO_BALTYPE_RA_MANAGED"),], &[]);
pub const MQBNO_OPTIONS_CONST: LinearSource = ConstSource(&[(0,"MQBNO_OPTIONS_NONE"),(1,"MQBNO_OPTIONS_IGNORE_TRANS"),], &[]);
pub const MQBNO_TIMEOUT_CONST: LinearSource = ConstSource(&[(-2,"MQBNO_TIMEOUT_NEVER"),(-1,"MQBNO_TIMEOUT_AS_DEFAULT"),(0,"MQBNO_TIMEOUT_IMMEDIATE"),], &[]);
pub const MQBO_CONST: LinearSource = ConstSource(&[(0,"MQBO_NONE"),], &[]);
pub const MQBPLOCATION_CONST: LinearSource = ConstSource(&[(0,"MQBPLOCATION_BELOW"),(1,"MQBPLOCATION_ABOVE"),(2,"MQBPLOCATION_SWITCHING_ABOVE"),(3,"MQBPLOCATION_SWITCHING_BELOW"),], &[]);
pub const MQBT_CONST: LinearSource = ConstSource(&[(1,"MQBT_OTMA"),], &[]);
pub const MQCACF_CONST: BinarySearchSource = ConstSource(BinarySearch(&[(3001,"MQCACF_FROM_Q_NAME"),(3002,"MQCACF_TO_Q_NAME"),(3003,"MQCACF_FROM_PROCESS_NAME"),(3004,"MQCACF_TO_PROCESS_NAME"),(3005,"MQCACF_FROM_NAMELIST_NAME"),(3006,"MQCACF_TO_NAMELIST_NAME"),(3007,"MQCACF_FROM_CHANNEL_NAME"),(3008,"MQCACF_TO_CHANNEL_NAME"),(3009,"MQCACF_FROM_AUTH_INFO_NAME"),(3010,"MQCACF_TO_AUTH_INFO_NAME"),(3011,"MQCACF_Q_NAMES"),(3012,"MQCACF_PROCESS_NAMES"),(3013,"MQCACF_NAMELIST_NAMES"),(3014,"MQCACF_ESCAPE_TEXT"),(3015,"MQCACF_LOCAL_Q_NAMES"),(3016,"MQCACF_MODEL_Q_NAMES"),(3017,"MQCACF_ALIAS_Q_NAMES"),(3018,"MQCACF_REMOTE_Q_NAMES"),(3019,"MQCACF_SENDER_CHANNEL_NAMES"),(3020,"MQCACF_SERVER_CHANNEL_NAMES"),(3021,"MQCACF_REQUESTER_CHANNEL_NAMES"),(3022,"MQCACF_RECEIVER_CHANNEL_NAMES"),(3023,"MQCACF_OBJECT_Q_MGR_NAME"),(3024,"MQCACF_APPL_NAME"),(3025,"MQCACF_USER_IDENTIFIER"),(3026,"MQCACF_AUX_ERROR_DATA_STR_1"),(3027,"MQCACF_AUX_ERROR_DATA_STR_2"),(3028,"MQCACF_AUX_ERROR_DATA_STR_3"),(3029,"MQCACF_BRIDGE_NAME"),(3030,"MQCACF_STREAM_NAME"),(3031,"MQCACF_TOPIC"),(3032,"MQCACF_PARENT_Q_MGR_NAME"),(3033,"MQCACF_CORREL_ID"),(3034,"MQCACF_PUBLISH_TIMESTAMP"),(3035,"MQCACF_STRING_DATA"),(3036,"MQCACF_SUPPORTED_STREAM_NAME"),(3037,"MQCACF_REG_TOPIC"),(3038,"MQCACF_REG_TIME"),(3039,"MQCACF_REG_USER_ID"),(3040,"MQCACF_CHILD_Q_MGR_NAME"),(3041,"MQCACF_REG_STREAM_NAME"),(3042,"MQCACF_REG_Q_MGR_NAME"),(3043,"MQCACF_REG_Q_NAME"),(3044,"MQCACF_REG_CORREL_ID"),(3045,"MQCACF_EVENT_USER_ID"),(3046,"MQCACF_OBJECT_NAME"),(3047,"MQCACF_EVENT_Q_MGR"),(3048,"MQCACF_AUTH_INFO_NAMES"),(3049,"MQCACF_EVENT_APPL_IDENTITY"),(3050,"MQCACF_EVENT_APPL_NAME"),(3051,"MQCACF_EVENT_APPL_ORIGIN"),(3052,"MQCACF_SUBSCRIPTION_NAME"),(3053,"MQCACF_REG_SUB_NAME"),(3054,"MQCACF_SUBSCRIPTION_IDENTITY"),(3055,"MQCACF_REG_SUB_IDENTITY"),(3056,"MQCACF_SUBSCRIPTION_USER_DATA"),(3057,"MQCACF_REG_SUB_USER_DATA"),(3058,"MQCACF_APPL_TAG"),(3059,"MQCACF_DATA_SET_NAME"),(3060,"MQCACF_UOW_START_DATE"),(3061,"MQCACF_UOW_START_TIME"),(3062,"MQCACF_UOW_LOG_START_DATE"),(3063,"MQCACF_UOW_LOG_START_TIME"),(3064,"MQCACF_UOW_LOG_EXTENT_NAME"),(3065,"MQCACF_PRINCIPAL_ENTITY_NAMES"),(3066,"MQCACF_GROUP_ENTITY_NAMES"),(3067,"MQCACF_AUTH_PROFILE_NAME"),(3068,"MQCACF_ENTITY_NAME"),(3069,"MQCACF_SERVICE_COMPONENT"),(3070,"MQCACF_RESPONSE_Q_MGR_NAME"),(3071,"MQCACF_CURRENT_LOG_EXTENT_NAME"),(3072,"MQCACF_RESTART_LOG_EXTENT_NAME"),(3073,"MQCACF_MEDIA_LOG_EXTENT_NAME"),(3074,"MQCACF_LOG_PATH"),(3075,"MQCACF_COMMAND_MQSC"),(3076,"MQCACF_Q_MGR_CPF"),(3078,"MQCACF_USAGE_LOG_RBA"),(3079,"MQCACF_USAGE_LOG_LRSN"),(3080,"MQCACF_COMMAND_SCOPE"),(3081,"MQCACF_ASID"),(3082,"MQCACF_PSB_NAME"),(3083,"MQCACF_PST_ID"),(3084,"MQCACF_TASK_NUMBER"),(3085,"MQCACF_TRANSACTION_ID"),(3086,"MQCACF_Q_MGR_UOW_ID"),(3088,"MQCACF_ORIGIN_NAME"),(3089,"MQCACF_ENV_INFO"),(3090,"MQCACF_SECURITY_PROFILE"),(3091,"MQCACF_CONFIGURATION_DATE"),(3092,"MQCACF_CONFIGURATION_TIME"),(3093,"MQCACF_FROM_CF_STRUC_NAME"),(3094,"MQCACF_TO_CF_STRUC_NAME"),(3095,"MQCACF_CF_STRUC_NAMES"),(3096,"MQCACF_FAIL_DATE"),(3097,"MQCACF_FAIL_TIME"),(3098,"MQCACF_BACKUP_DATE"),(3099,"MQCACF_BACKUP_TIME"),(3100,"MQCACF_SYSTEM_NAME"),(3101,"MQCACF_CF_STRUC_BACKUP_START"),(3102,"MQCACF_CF_STRUC_BACKUP_END"),(3103,"MQCACF_CF_STRUC_LOG_Q_MGRS"),(3104,"MQCACF_FROM_STORAGE_CLASS"),(3105,"MQCACF_TO_STORAGE_CLASS"),(3106,"MQCACF_STORAGE_CLASS_NAMES"),(3108,"MQCACF_DSG_NAME"),(3109,"MQCACF_DB2_NAME"),(3110,"MQCACF_SYSP_CMD_USER_ID"),(3111,"MQCACF_SYSP_OTMA_GROUP"),(3112,"MQCACF_SYSP_OTMA_MEMBER"),(3113,"MQCACF_SYSP_OTMA_DRU_EXIT"),(3114,"MQCACF_SYSP_OTMA_TPIPE_PFX"),(3115,"MQCACF_SYSP_ARCHIVE_PFX1"),(3116,"MQCACF_SYSP_ARCHIVE_UNIT1"),(3117,"MQCACF_SYSP_LOG_CORREL_ID"),(3118,"MQCACF_SYSP_UNIT_VOLSER"),(3119,"MQCACF_SYSP_Q_MGR_TIME"),(3120,"MQCACF_SYSP_Q_MGR_DATE"),(3121,"MQCACF_SYSP_Q_MGR_RBA"),(3122,"MQCACF_SYSP_LOG_RBA"),(3123,"MQCACF_SYSP_SERVICE"),(3124,"MQCACF_FROM_LISTENER_NAME"),(3125,"MQCACF_TO_LISTENER_NAME"),(3126,"MQCACF_FROM_SERVICE_NAME"),(3127,"MQCACF_TO_SERVICE_NAME"),(3128,"MQCACF_LAST_PUT_DATE"),(3129,"MQCACF_LAST_PUT_TIME"),(3130,"MQCACF_LAST_GET_DATE"),(3131,"MQCACF_LAST_GET_TIME"),(3132,"MQCACF_OPERATION_DATE"),(3133,"MQCACF_OPERATION_TIME"),(3134,"MQCACF_ACTIVITY_DESC"),(3135,"MQCACF_APPL_IDENTITY_DATA"),(3136,"MQCACF_APPL_ORIGIN_DATA"),(3137,"MQCACF_PUT_DATE"),(3138,"MQCACF_PUT_TIME"),(3139,"MQCACF_REPLY_TO_Q"),(3140,"MQCACF_REPLY_TO_Q_MGR"),(3141,"MQCACF_RESOLVED_Q_NAME"),(3142,"MQCACF_STRUC_ID"),(3143,"MQCACF_VALUE_NAME"),(3144,"MQCACF_SERVICE_START_DATE"),(3145,"MQCACF_SERVICE_START_TIME"),(3146,"MQCACF_SYSP_OFFLINE_RBA"),(3147,"MQCACF_SYSP_ARCHIVE_PFX2"),(3148,"MQCACF_SYSP_ARCHIVE_UNIT2"),(3149,"MQCACF_TO_TOPIC_NAME"),(3150,"MQCACF_FROM_TOPIC_NAME"),(3151,"MQCACF_TOPIC_NAMES"),(3152,"MQCACF_SUB_NAME"),(3153,"MQCACF_DESTINATION_Q_MGR"),(3154,"MQCACF_DESTINATION"),(3156,"MQCACF_SUB_USER_ID"),(3159,"MQCACF_SUB_USER_DATA"),(3160,"MQCACF_SUB_SELECTOR"),(3161,"MQCACF_LAST_PUB_DATE"),(3162,"MQCACF_LAST_PUB_TIME"),(3163,"MQCACF_FROM_SUB_NAME"),(3164,"MQCACF_TO_SUB_NAME"),(3167,"MQCACF_LAST_MSG_TIME"),(3168,"MQCACF_LAST_MSG_DATE"),(3169,"MQCACF_SUBSCRIPTION_POINT"),(3170,"MQCACF_FILTER"),(3171,"MQCACF_NONE"),(3172,"MQCACF_ADMIN_TOPIC_NAMES"),(3173,"MQCACF_ROUTING_FINGER_PRINT"),(3174,"MQCACF_APPL_DESC"),(3175,"MQCACF_Q_MGR_START_DATE"),(3176,"MQCACF_Q_MGR_START_TIME"),(3177,"MQCACF_FROM_COMM_INFO_NAME"),(3178,"MQCACF_TO_COMM_INFO_NAME"),(3179,"MQCACF_CF_OFFLOAD_SIZE1"),(3180,"MQCACF_CF_OFFLOAD_SIZE2"),(3181,"MQCACF_CF_OFFLOAD_SIZE3"),(3182,"MQCACF_CF_SMDS_GENERIC_NAME"),(3183,"MQCACF_CF_SMDS"),(3184,"MQCACF_RECOVERY_DATE"),(3185,"MQCACF_RECOVERY_TIME"),(3186,"MQCACF_CF_SMDSCONN"),(3187,"MQCACF_CF_STRUC_NAME"),(3188,"MQCACF_ALTERNATE_USERID"),(3189,"MQCACF_CHAR_ATTRS"),(3190,"MQCACF_DYNAMIC_Q_NAME"),(3191,"MQCACF_HOST_NAME"),(3192,"MQCACF_MQCB_NAME"),(3193,"MQCACF_OBJECT_STRING"),(3194,"MQCACF_RESOLVED_LOCAL_Q_MGR"),(3195,"MQCACF_RESOLVED_LOCAL_Q_NAME"),(3196,"MQCACF_RESOLVED_OBJECT_STRING"),(3197,"MQCACF_RESOLVED_Q_MGR"),(3198,"MQCACF_SELECTION_STRING"),(3199,"MQCACF_XA_INFO"),(3200,"MQCACF_APPL_FUNCTION"),(3201,"MQCACF_XQH_REMOTE_Q_NAME"),(3202,"MQCACF_XQH_REMOTE_Q_MGR"),(3203,"MQCACF_XQH_PUT_TIME"),(3204,"MQCACF_XQH_PUT_DATE"),(3205,"MQCACF_EXCL_OPERATOR_MESSAGES"),(3206,"MQCACF_CSP_USER_IDENTIFIER"),(3207,"MQCACF_AMQP_CLIENT_ID"),(3208,"MQCACF_ARCHIVE_LOG_EXTENT_NAME"),(3209,"MQCACF_APPL_IMMOVABLE_DATE"),(3210,"MQCACF_APPL_IMMOVABLE_TIME"),(3211,"MQCACF_NHA_INSTANCE_NAME"),(3212,"MQCACF_Q_MGR_DATA_PATH"),(3213,"MQCACF_UNIFORM_CLUSTER_NAME"),(3214,"MQCACF_LOG_START_DATE"),(3215,"MQCACF_LOG_START_LSN"),(3216,"MQCACF_LOG_START_TIME"),(3217,"MQCACF_NHA_GROUP_INITIAL_DATE"),(3218,"MQCACF_NHA_GROUP_INITIAL_LSN"),(3219,"MQCACF_NHA_GROUP_INITIAL_TIME"),(3220,"MQCACF_NHA_REPL_ADDRESS"),]), &[]);
pub const MQCACH_CONST: LinearSource = ConstSource(&[(3501,"MQCACH_CHANNEL_NAME"),(3502,"MQCACH_DESC"),(3503,"MQCACH_MODE_NAME"),(3504,"MQCACH_TP_NAME"),(3505,"MQCACH_XMIT_Q_NAME"),(3506,"MQCACH_CONNECTION_NAME"),(3507,"MQCACH_MCA_NAME"),(3508,"MQCACH_SEC_EXIT_NAME"),(3509,"MQCACH_MSG_EXIT_NAME"),(3510,"MQCACH_SEND_EXIT_NAME"),(3511,"MQCACH_RCV_EXIT_NAME"),(3512,"MQCACH_CHANNEL_NAMES"),(3513,"MQCACH_SEC_EXIT_USER_DATA"),(3514,"MQCACH_MSG_EXIT_USER_DATA"),(3515,"MQCACH_SEND_EXIT_USER_DATA"),(3516,"MQCACH_RCV_EXIT_USER_DATA"),(3517,"MQCACH_USER_ID"),(3518,"MQCACH_PASSWORD"),(3520,"MQCACH_LOCAL_ADDRESS"),(3521,"MQCACH_LOCAL_NAME"),(3524,"MQCACH_LAST_MSG_TIME"),(3525,"MQCACH_LAST_MSG_DATE"),(3527,"MQCACH_MCA_USER_ID"),(3528,"MQCACH_CHANNEL_START_TIME"),(3529,"MQCACH_CHANNEL_START_DATE"),(3530,"MQCACH_MCA_JOB_NAME"),(3531,"MQCACH_LAST_LUWID"),(3532,"MQCACH_CURRENT_LUWID"),(3533,"MQCACH_FORMAT_NAME"),(3534,"MQCACH_MR_EXIT_NAME"),(3535,"MQCACH_MR_EXIT_USER_DATA"),(3544,"MQCACH_SSL_CIPHER_SPEC"),(3545,"MQCACH_SSL_PEER_NAME"),(3546,"MQCACH_SSL_HANDSHAKE_STAGE"),(3547,"MQCACH_SSL_SHORT_PEER_NAME"),(3548,"MQCACH_REMOTE_APPL_TAG"),(3549,"MQCACH_SSL_CERT_USER_ID"),(3550,"MQCACH_SSL_CERT_ISSUER_NAME"),(3551,"MQCACH_LU_NAME"),(3552,"MQCACH_IP_ADDRESS"),(3553,"MQCACH_TCP_NAME"),(3554,"MQCACH_LISTENER_NAME"),(3555,"MQCACH_LISTENER_DESC"),(3556,"MQCACH_LISTENER_START_DATE"),(3557,"MQCACH_LISTENER_START_TIME"),(3558,"MQCACH_SSL_KEY_RESET_DATE"),(3559,"MQCACH_SSL_KEY_RESET_TIME"),(3560,"MQCACH_REMOTE_VERSION"),(3561,"MQCACH_REMOTE_PRODUCT"),(3562,"MQCACH_GROUP_ADDRESS"),(3563,"MQCACH_JAAS_CONFIG"),(3564,"MQCACH_CLIENT_ID"),(3565,"MQCACH_SSL_KEY_PASSPHRASE"),(3566,"MQCACH_CONNECTION_NAME_LIST"),(3567,"MQCACH_CLIENT_USER_ID"),(3568,"MQCACH_MCA_USER_ID_LIST"),(3569,"MQCACH_SSL_CIPHER_SUITE"),(3570,"MQCACH_WEBCONTENT_PATH"),(3571,"MQCACH_TOPIC_ROOT"),(3572,"MQCACH_TEMPORARY_MODEL_Q"),(3573,"MQCACH_TEMPORARY_Q_PREFIX"),], &[]);
pub const MQCADSD_CONST: LinearSource = ConstSource(&[(0,"MQCADSD_NONE"),(1,"MQCADSD_SEND"),(16,"MQCADSD_RECV"),(256,"MQCADSD_MSGFORMAT"),], &[]);
pub const MQCAFTY_CONST: LinearSource = ConstSource(&[(0,"MQCAFTY_NONE"),(1,"MQCAFTY_PREFERRED"),], &[]);
pub const MQCAMO_CONST: LinearSource = ConstSource(&[(2701,"MQCAMO_CLOSE_DATE"),(2702,"MQCAMO_CLOSE_TIME"),(2703,"MQCAMO_CONN_DATE"),(2704,"MQCAMO_CONN_TIME"),(2705,"MQCAMO_DISC_DATE"),(2706,"MQCAMO_DISC_TIME"),(2707,"MQCAMO_END_DATE"),(2708,"MQCAMO_END_TIME"),(2709,"MQCAMO_OPEN_DATE"),(2710,"MQCAMO_OPEN_TIME"),(2711,"MQCAMO_START_DATE"),(2712,"MQCAMO_START_TIME"),(2713,"MQCAMO_MONITOR_CLASS"),(2714,"MQCAMO_MONITOR_TYPE"),(2715,"MQCAMO_MONITOR_DESC"),], &[]);
pub const MQCAP_CONST: LinearSource = ConstSource(&[(0,"MQCAP_NOT_SUPPORTED"),(1,"MQCAP_SUPPORTED"),(2,"MQCAP_EXPIRED"),], &[]);
pub const MQCAUT_CONST: LinearSource = ConstSource(&[(0,"MQCAUT_ALL"),(1,"MQCAUT_BLOCKUSER"),(2,"MQCAUT_BLOCKADDR"),(3,"MQCAUT_SSLPEERMAP"),(4,"MQCAUT_ADDRESSMAP"),(5,"MQCAUT_USERMAP"),(6,"MQCAUT_QMGRMAP"),], &[]);
pub const MQCA_CONST: BinarySearchSource = ConstSource(BinarySearch(&[(2001,"MQCA_APPL_ID"),(2002,"MQCA_BASE_OBJECT_NAME"),(2003,"MQCA_COMMAND_INPUT_Q_NAME"),(2004,"MQCA_CREATION_DATE"),(2005,"MQCA_CREATION_TIME"),(2006,"MQCA_DEAD_LETTER_Q_NAME"),(2007,"MQCA_ENV_DATA"),(2008,"MQCA_INITIATION_Q_NAME"),(2009,"MQCA_NAMELIST_DESC"),(2010,"MQCA_NAMELIST_NAME"),(2011,"MQCA_PROCESS_DESC"),(2012,"MQCA_PROCESS_NAME"),(2013,"MQCA_Q_DESC"),(2014,"MQCA_Q_MGR_DESC"),(2015,"MQCA_Q_MGR_NAME"),(2016,"MQCA_Q_NAME"),(2017,"MQCA_REMOTE_Q_MGR_NAME"),(2018,"MQCA_REMOTE_Q_NAME"),(2019,"MQCA_BACKOUT_REQ_Q_NAME"),(2020,"MQCA_NAMES"),(2021,"MQCA_USER_DATA"),(2022,"MQCA_STORAGE_CLASS"),(2023,"MQCA_TRIGGER_DATA"),(2024,"MQCA_XMIT_Q_NAME"),(2025,"MQCA_DEF_XMIT_Q_NAME"),(2026,"MQCA_CHANNEL_AUTO_DEF_EXIT"),(2027,"MQCA_ALTERATION_DATE"),(2028,"MQCA_ALTERATION_TIME"),(2029,"MQCA_CLUSTER_NAME"),(2030,"MQCA_CLUSTER_NAMELIST"),(2031,"MQCA_CLUSTER_Q_MGR_NAME"),(2032,"MQCA_Q_MGR_IDENTIFIER"),(2033,"MQCA_CLUSTER_WORKLOAD_EXIT"),(2034,"MQCA_CLUSTER_WORKLOAD_DATA"),(2035,"MQCA_REPOSITORY_NAME"),(2036,"MQCA_REPOSITORY_NAMELIST"),(2037,"MQCA_CLUSTER_DATE"),(2038,"MQCA_CLUSTER_TIME"),(2039,"MQCA_CF_STRUC_NAME"),(2040,"MQCA_QSG_NAME"),(2041,"MQCA_IGQ_USER_ID"),(2042,"MQCA_STORAGE_CLASS_DESC"),(2043,"MQCA_XCF_GROUP_NAME"),(2044,"MQCA_XCF_MEMBER_NAME"),(2045,"MQCA_AUTH_INFO_NAME"),(2046,"MQCA_AUTH_INFO_DESC"),(2047,"MQCA_LDAP_USER_NAME"),(2048,"MQCA_LDAP_PASSWORD"),(2049,"MQCA_SSL_KEY_REPOSITORY"),(2050,"MQCA_SSL_CRL_NAMELIST"),(2051,"MQCA_SSL_CRYPTO_HARDWARE"),(2052,"MQCA_CF_STRUC_DESC"),(2053,"MQCA_AUTH_INFO_CONN_NAME"),(2054,"MQCA_INITIAL_KEY"),(2055,"MQCA_SSL_KEY_REPO_PASSWORD"),(2060,"MQCA_CICS_FILE_NAME"),(2061,"MQCA_TRIGGER_TRANS_ID"),(2062,"MQCA_TRIGGER_PROGRAM_NAME"),(2063,"MQCA_TRIGGER_TERM_ID"),(2064,"MQCA_TRIGGER_CHANNEL_NAME"),(2065,"MQCA_SYSTEM_LOG_Q_NAME"),(2066,"MQCA_MONITOR_Q_NAME"),(2067,"MQCA_COMMAND_REPLY_Q_NAME"),(2068,"MQCA_BATCH_INTERFACE_ID"),(2069,"MQCA_SSL_KEY_LIBRARY"),(2070,"MQCA_SSL_KEY_MEMBER"),(2071,"MQCA_DNS_GROUP"),(2072,"MQCA_LU_GROUP_NAME"),(2073,"MQCA_LU_NAME"),(2074,"MQCA_LU62_ARM_SUFFIX"),(2075,"MQCA_TCP_NAME"),(2076,"MQCA_CHINIT_SERVICE_PARM"),(2077,"MQCA_SERVICE_NAME"),(2078,"MQCA_SERVICE_DESC"),(2079,"MQCA_SERVICE_START_COMMAND"),(2080,"MQCA_SERVICE_START_ARGS"),(2081,"MQCA_SERVICE_STOP_COMMAND"),(2082,"MQCA_SERVICE_STOP_ARGS"),(2083,"MQCA_STDOUT_DESTINATION"),(2084,"MQCA_STDERR_DESTINATION"),(2085,"MQCA_TPIPE_NAME"),(2086,"MQCA_PASS_TICKET_APPL"),(2090,"MQCA_AUTO_REORG_START_TIME"),(2091,"MQCA_AUTO_REORG_CATALOG"),(2092,"MQCA_TOPIC_NAME"),(2093,"MQCA_TOPIC_DESC"),(2094,"MQCA_TOPIC_STRING"),(2096,"MQCA_MODEL_DURABLE_Q"),(2097,"MQCA_MODEL_NON_DURABLE_Q"),(2098,"MQCA_RESUME_DATE"),(2099,"MQCA_RESUME_TIME"),(2101,"MQCA_CHILD"),(2102,"MQCA_PARENT"),(2105,"MQCA_ADMIN_TOPIC_NAME"),(2108,"MQCA_TOPIC_STRING_FILTER"),(2109,"MQCA_AUTH_INFO_OCSP_URL"),(2110,"MQCA_COMM_INFO_NAME"),(2111,"MQCA_COMM_INFO_DESC"),(2112,"MQCA_POLICY_NAME"),(2113,"MQCA_SIGNER_DN"),(2114,"MQCA_RECIPIENT_DN"),(2115,"MQCA_INSTALLATION_DESC"),(2116,"MQCA_INSTALLATION_NAME"),(2117,"MQCA_INSTALLATION_PATH"),(2118,"MQCA_CHLAUTH_DESC"),(2119,"MQCA_CUSTOM"),(2120,"MQCA_VERSION"),(2121,"MQCA_CERT_LABEL"),(2122,"MQCA_XR_VERSION"),(2123,"MQCA_XR_SSL_CIPHER_SUITES"),(2124,"MQCA_CLUS_CHL_NAME"),(2125,"MQCA_CONN_AUTH"),(2126,"MQCA_LDAP_BASE_DN_USERS"),(2127,"MQCA_LDAP_SHORT_USER_FIELD"),(2128,"MQCA_LDAP_USER_OBJECT_CLASS"),(2129,"MQCA_LDAP_USER_ATTR_FIELD"),(2130,"MQCA_SSL_CERT_ISSUER_NAME"),(2131,"MQCA_QSG_CERT_LABEL"),(2132,"MQCA_LDAP_BASE_DN_GROUPS"),(2133,"MQCA_LDAP_GROUP_OBJECT_CLASS"),(2134,"MQCA_LDAP_GROUP_ATTR_FIELD"),(2135,"MQCA_LDAP_FIND_GROUP_FIELD"),(2136,"MQCA_AMQP_VERSION"),(2137,"MQCA_AMQP_SSL_CIPHER_SUITES"),(2138,"MQCA_STREAM_QUEUE_NAME"),(4000,"MQCA_USER_LIST"),]), &[(2002,"MQCA_BASE_Q_NAME"),]);
pub const MQCBCF_CONST: LinearSource = ConstSource(&[(0,"MQCBCF_NONE"),(1,"MQCBCF_READA_BUFFER_EMPTY"),], &[]);
pub const MQCBCT_CONST: LinearSource = ConstSource(&[(1,"MQCBCT_START_CALL"),(2,"MQCBCT_STOP_CALL"),(3,"MQCBCT_REGISTER_CALL"),(4,"MQCBCT_DEREGISTER_CALL"),(5,"MQCBCT_EVENT_CALL"),(6,"MQCBCT_MSG_REMOVED"),(7,"MQCBCT_MSG_NOT_REMOVED"),(8,"MQCBCT_MC_EVENT_CALL"),], &[]);
pub const MQCBDO_CONST: LinearSource = ConstSource(&[(0,"MQCBDO_NONE"),(1,"MQCBDO_START_CALL"),(4,"MQCBDO_STOP_CALL"),(256,"MQCBDO_REGISTER_CALL"),(512,"MQCBDO_DEREGISTER_CALL"),(8192,"MQCBDO_FAIL_IF_QUIESCING"),(16384,"MQCBDO_EVENT_CALL"),(32768,"MQCBDO_MC_EVENT_CALL"),], &[]);
pub const MQCBD_CONST: LinearSource = ConstSource(&[(-1,"MQCBD_FULL_MSG_LENGTH"),], &[]);
pub const MQCBO_CONST: LinearSource = ConstSource(&[(0,"MQCBO_NONE"),(1,"MQCBO_ADMIN_BAG"),(2,"MQCBO_LIST_FORM_ALLOWED"),(4,"MQCBO_REORDER_AS_REQUIRED"),(8,"MQCBO_CHECK_SELECTORS"),(16,"MQCBO_COMMAND_BAG"),(32,"MQCBO_SYSTEM_BAG"),(64,"MQCBO_GROUP_BAG"),], &[(0,"MQCBO_DO_NOT_CHECK_SELECTORS"),(0,"MQCBO_DO_NOT_REORDER"),(0,"MQCBO_LIST_FORM_INHIBITED"),(0,"MQCBO_USER_BAG"),]);
pub const MQCBT_CONST: LinearSource = ConstSource(&[(1,"MQCBT_MESSAGE_CONSUMER"),(2,"MQCBT_EVENT_HANDLER"),], &[]);
pub const MQCCSI_CONST: LinearSource = ConstSource(&[(-4,"MQCCSI_AS_PUBLISHED"),(-3,"MQCCSI_APPL"),(-2,"MQCCSI_INHERIT"),(-1,"MQCCSI_EMBEDDED"),(0,"MQCCSI_DEFAULT"),], &[(0,"MQCCSI_Q_MGR"),(0,"MQCCSI_UNDEFINED"),]);
pub const MQCCT_CONST: LinearSource = ConstSource(&[(0,"MQCCT_NO"),(1,"MQCCT_YES"),], &[]);
pub const MQCC_CONST: LinearSource = ConstSource(&[(-1,"MQCC_UNKNOWN"),(0,"MQCC_OK"),(1,"MQCC_WARNING"),(2,"MQCC_FAILED"),], &[]);
pub const MQCDC_CONST: LinearSource = ConstSource(&[(0,"MQCDC_NO_SENDER_CONVERSION"),(1,"MQCDC_SENDER_CONVERSION"),], &[]);
pub const MQCEX_CONST: LinearSource = ConstSource(&[(-2,"MQCEX_AS_PARENT"),(-1,"MQCEX_NOLIMIT"),], &[]);
pub const MQCFACCESS_CONST: LinearSource = ConstSource(&[(0,"MQCFACCESS_ENABLED"),(1,"MQCFACCESS_SUSPENDED"),(2,"MQCFACCESS_DISABLED"),], &[]);
pub const MQCFCONLOS_CONST: LinearSource = ConstSource(&[(0,"MQCFCONLOS_TERMINATE"),(1,"MQCFCONLOS_TOLERATE"),(2,"MQCFCONLOS_ASQMGR"),], &[]);
pub const MQCFC_CONST: LinearSource = ConstSource(&[(0,"MQCFC_NOT_LAST"),(1,"MQCFC_LAST"),], &[]);
pub const MQCFOFFLD_CONST: LinearSource = ConstSource(&[(0,"MQCFOFFLD_NONE"),(1,"MQCFOFFLD_SMDS"),(2,"MQCFOFFLD_DB2"),(3,"MQCFOFFLD_BOTH"),], &[]);
pub const MQCFOP_CONST: LinearSource = ConstSource(&[(1,"MQCFOP_LESS"),(2,"MQCFOP_EQUAL"),(3,"MQCFOP_NOT_GREATER"),(4,"MQCFOP_GREATER"),(5,"MQCFOP_NOT_EQUAL"),(6,"MQCFOP_NOT_LESS"),(10,"MQCFOP_CONTAINS"),(13,"MQCFOP_EXCLUDES"),(18,"MQCFOP_LIKE"),(21,"MQCFOP_NOT_LIKE"),(26,"MQCFOP_CONTAINS_GEN"),(29,"MQCFOP_EXCLUDES_GEN"),], &[]);
pub const MQCFO_REFRESH_CONST: LinearSource = ConstSource(&[(0,"MQCFO_REFRESH_REPOSITORY_NO"),(1,"MQCFO_REFRESH_REPOSITORY_YES"),], &[]);
pub const MQCFO_REMOVE_CONST: LinearSource = ConstSource(&[(0,"MQCFO_REMOVE_QUEUES_NO"),(1,"MQCFO_REMOVE_QUEUES_YES"),], &[]);
pub const MQCFR_CONST: LinearSource = ConstSource(&[(0,"MQCFR_NO"),(1,"MQCFR_YES"),], &[]);
pub const MQCFSTATUS_CONST: LinearSource = ConstSource(&[(0,"MQCFSTATUS_NOT_FOUND"),(1,"MQCFSTATUS_ACTIVE"),(2,"MQCFSTATUS_IN_RECOVER"),(3,"MQCFSTATUS_IN_BACKUP"),(4,"MQCFSTATUS_FAILED"),(5,"MQCFSTATUS_NONE"),(6,"MQCFSTATUS_UNKNOWN"),(7,"MQCFSTATUS_RECOVERED"),(8,"MQCFSTATUS_EMPTY"),(9,"MQCFSTATUS_NEW"),(20,"MQCFSTATUS_ADMIN_INCOMPLETE"),(21,"MQCFSTATUS_NEVER_USED"),(22,"MQCFSTATUS_NO_BACKUP"),(23,"MQCFSTATUS_NOT_FAILED"),(24,"MQCFSTATUS_NOT_RECOVERABLE"),(25,"MQCFSTATUS_XES_ERROR"),], &[]);
pub const MQCFTYPE_CONST: LinearSource = ConstSource(&[(0,"MQCFTYPE_APPL"),(1,"MQCFTYPE_ADMIN"),], &[]);
pub const MQCFT_CONST: LinearSource = ConstSource(&[(0,"MQCFT_NONE"),(1,"MQCFT_COMMAND"),(2,"MQCFT_RESPONSE"),(3,"MQCFT_INTEGER"),(4,"MQCFT_STRING"),(5,"MQCFT_INTEGER_LIST"),(6,"MQCFT_STRING_LIST"),(7,"MQCFT_EVENT"),(8,"MQCFT_USER"),(9,"MQCFT_BYTE_STRING"),(10,"MQCFT_TRACE_ROUTE"),(12,"MQCFT_REPORT"),(13,"MQCFT_INTEGER_FILTER"),(14,"MQCFT_STRING_FILTER"),(15,"MQCFT_BYTE_STRING_FILTER"),(16,"MQCFT_COMMAND_XR"),(17,"MQCFT_XR_MSG"),(18,"MQCFT_XR_ITEM"),(19,"MQCFT_XR_SUMMARY"),(20,"MQCFT_GROUP"),(21,"MQCFT_STATISTICS"),(22,"MQCFT_ACCOUNTING"),(23,"MQCFT_INTEGER64"),(25,"MQCFT_INTEGER64_LIST"),(26,"MQCFT_APP_ACTIVITY"),(27,"MQCFT_STATUS"),], &[]);
pub const MQCF_CONST: LinearSource = ConstSource(&[(0,"MQCF_NONE"),(1,"MQCF_DIST_LISTS"),], &[]);
pub const MQCGWI_CONST: LinearSource = ConstSource(&[(-2,"MQCGWI_DEFAULT"),], &[]);
pub const MQCHAD_CONST: LinearSource = ConstSource(&[(0,"MQCHAD_DISABLED"),(1,"MQCHAD_ENABLED"),], &[]);
pub const MQCHIDS_CONST: LinearSource = ConstSource(&[(0,"MQCHIDS_NOT_INDOUBT"),(1,"MQCHIDS_INDOUBT"),], &[]);
pub const MQCHK_CONST: LinearSource = ConstSource(&[(0,"MQCHK_OPTIONAL"),(1,"MQCHK_NONE"),(2,"MQCHK_REQUIRED_ADMIN"),(3,"MQCHK_REQUIRED"),(4,"MQCHK_AS_Q_MGR"),], &[]);
pub const MQCHLA_CONST: LinearSource = ConstSource(&[(0,"MQCHLA_DISABLED"),(1,"MQCHLA_ENABLED"),], &[]);
pub const MQCHLD_CONST: LinearSource = ConstSource(&[(-1,"MQCHLD_ALL"),(1,"MQCHLD_DEFAULT"),(2,"MQCHLD_SHARED"),(4,"MQCHLD_PRIVATE"),(5,"MQCHLD_FIXSHARED"),], &[]);
pub const MQCHRR_CONST: LinearSource = ConstSource(&[(0,"MQCHRR_RESET_NOT_REQUESTED"),], &[]);
pub const MQCHSH_CONST: LinearSource = ConstSource(&[(0,"MQCHSH_RESTART_NO"),(1,"MQCHSH_RESTART_YES"),], &[]);
pub const MQCHSR_CONST: LinearSource = ConstSource(&[(0,"MQCHSR_STOP_NOT_REQUESTED"),(1,"MQCHSR_STOP_REQUESTED"),], &[]);
pub const MQCHSSTATE_CONST: LinearSource = ConstSource(&[(0,"MQCHSSTATE_OTHER"),(100,"MQCHSSTATE_END_OF_BATCH"),(200,"MQCHSSTATE_SENDING"),(300,"MQCHSSTATE_RECEIVING"),(400,"MQCHSSTATE_SERIALIZING"),(500,"MQCHSSTATE_RESYNCHING"),(600,"MQCHSSTATE_HEARTBEATING"),(700,"MQCHSSTATE_IN_SCYEXIT"),(800,"MQCHSSTATE_IN_RCVEXIT"),(900,"MQCHSSTATE_IN_SENDEXIT"),(1000,"MQCHSSTATE_IN_MSGEXIT"),(1100,"MQCHSSTATE_IN_MREXIT"),(1200,"MQCHSSTATE_IN_CHADEXIT"),(1250,"MQCHSSTATE_NET_CONNECTING"),(1300,"MQCHSSTATE_SSL_HANDSHAKING"),(1400,"MQCHSSTATE_NAME_SERVER"),(1500,"MQCHSSTATE_IN_MQPUT"),(1600,"MQCHSSTATE_IN_MQGET"),(1700,"MQCHSSTATE_IN_MQI_CALL"),(1800,"MQCHSSTATE_COMPRESSING"),], &[]);
pub const MQCHS_CONST: LinearSource = ConstSource(&[(0,"MQCHS_INACTIVE"),(1,"MQCHS_BINDING"),(2,"MQCHS_STARTING"),(3,"MQCHS_RUNNING"),(4,"MQCHS_STOPPING"),(5,"MQCHS_RETRYING"),(6,"MQCHS_STOPPED"),(7,"MQCHS_REQUESTING"),(8,"MQCHS_PAUSED"),(9,"MQCHS_DISCONNECTED"),(13,"MQCHS_INITIALIZING"),(14,"MQCHS_SWITCHING"),], &[]);
pub const MQCHTAB_CONST: LinearSource = ConstSource(&[(1,"MQCHTAB_Q_MGR"),(2,"MQCHTAB_CLNTCONN"),], &[]);
pub const MQCHT_CONST: LinearSource = ConstSource(&[(1,"MQCHT_SENDER"),(2,"MQCHT_SERVER"),(3,"MQCHT_RECEIVER"),(4,"MQCHT_REQUESTER"),(5,"MQCHT_ALL"),(6,"MQCHT_CLNTCONN"),(7,"MQCHT_SVRCONN"),(8,"MQCHT_CLUSRCVR"),(9,"MQCHT_CLUSSDR"),(10,"MQCHT_MQTT"),(11,"MQCHT_AMQP"),], &[]);
pub const MQCIH_CONST: LinearSource = ConstSource(&[(0,"MQCIH_NONE"),(1,"MQCIH_PASS_EXPIRATION"),(2,"MQCIH_REPLY_WITHOUT_NULLS"),(4,"MQCIH_SYNC_ON_RETURN"),], &[(0,"MQCIH_NO_SYNC_ON_RETURN"),(0,"MQCIH_REPLY_WITH_NULLS"),(0,"MQCIH_UNLIMITED_EXPIRATION"),]);
pub const MQCIT_CONST: LinearSource = ConstSource(&[(1,"MQCIT_MULTICAST"),], &[]);
pub const MQCLCT_CONST: LinearSource = ConstSource(&[(0,"MQCLCT_STATIC"),(1,"MQCLCT_DYNAMIC"),], &[]);
pub const MQCLROUTE_CONST: LinearSource = ConstSource(&[(0,"MQCLROUTE_DIRECT"),(1,"MQCLROUTE_TOPIC_HOST"),(2,"MQCLROUTE_NONE"),], &[]);
pub const MQCLRS_CONST: LinearSource = ConstSource(&[(1,"MQCLRS_LOCAL"),(2,"MQCLRS_GLOBAL"),], &[]);
pub const MQCLRT_CONST: LinearSource = ConstSource(&[(1,"MQCLRT_RETAINED"),], &[]);
pub const MQCLST_CONST: LinearSource = ConstSource(&[(0,"MQCLST_ACTIVE"),(1,"MQCLST_PENDING"),(2,"MQCLST_INVALID"),(3,"MQCLST_ERROR"),], &[]);
pub const MQCLT_CONST: LinearSource = ConstSource(&[(1,"MQCLT_PROGRAM"),(2,"MQCLT_TRANSACTION"),], &[]);
pub const MQCLWL_CONST: LinearSource = ConstSource(&[(-3,"MQCLWL_USEQ_AS_Q_MGR"),(0,"MQCLWL_USEQ_LOCAL"),(1,"MQCLWL_USEQ_ANY"),], &[]);
pub const MQCLXQ_CONST: LinearSource = ConstSource(&[(0,"MQCLXQ_SCTQ"),(1,"MQCLXQ_CHANNEL"),], &[]);
pub const MQCMDI_CONST: LinearSource = ConstSource(&[(1,"MQCMDI_CMDSCOPE_ACCEPTED"),(2,"MQCMDI_CMDSCOPE_GENERATED"),(3,"MQCMDI_CMDSCOPE_COMPLETED"),(4,"MQCMDI_QSG_DISP_COMPLETED"),(5,"MQCMDI_COMMAND_ACCEPTED"),(6,"MQCMDI_CLUSTER_REQUEST_QUEUED"),(7,"MQCMDI_CHANNEL_INIT_STARTED"),(11,"MQCMDI_RECOVER_STARTED"),(12,"MQCMDI_BACKUP_STARTED"),(13,"MQCMDI_RECOVER_COMPLETED"),(14,"MQCMDI_SEC_TIMER_ZERO"),(16,"MQCMDI_REFRESH_CONFIGURATION"),(17,"MQCMDI_SEC_SIGNOFF_ERROR"),(18,"MQCMDI_IMS_BRIDGE_SUSPENDED"),(19,"MQCMDI_DB2_SUSPENDED"),(20,"MQCMDI_DB2_OBSOLETE_MSGS"),(21,"MQCMDI_SEC_UPPERCASE"),(22,"MQCMDI_SEC_MIXEDCASE"),], &[]);
pub const MQCMDL_CONST: LinearSource = ConstSource(&[(100,"MQCMDL_LEVEL_1"),(101,"MQCMDL_LEVEL_101"),(110,"MQCMDL_LEVEL_110"),(114,"MQCMDL_LEVEL_114"),(120,"MQCMDL_LEVEL_120"),(200,"MQCMDL_LEVEL_200"),(201,"MQCMDL_LEVEL_201"),(210,"MQCMDL_LEVEL_210"),(211,"MQCMDL_LEVEL_211"),(220,"MQCMDL_LEVEL_220"),(221,"MQCMDL_LEVEL_221"),(230,"MQCMDL_LEVEL_230"),(320,"MQCMDL_LEVEL_320"),(420,"MQCMDL_LEVEL_420"),(500,"MQCMDL_LEVEL_500"),(510,"MQCMDL_LEVEL_510"),(520,"MQCMDL_LEVEL_520"),(530,"MQCMDL_LEVEL_530"),(531,"MQCMDL_LEVEL_531"),(600,"MQCMDL_LEVEL_600"),(700,"MQCMDL_LEVEL_700"),(701,"MQCMDL_LEVEL_701"),(710,"MQCMDL_LEVEL_710"),(711,"MQCMDL_LEVEL_711"),(750,"MQCMDL_LEVEL_750"),(800,"MQCMDL_LEVEL_800"),(801,"MQCMDL_LEVEL_801"),(802,"MQCMDL_LEVEL_802"),(900,"MQCMDL_LEVEL_900"),(901,"MQCMDL_LEVEL_901"),(902,"MQCMDL_LEVEL_902"),(903,"MQCMDL_LEVEL_903"),(904,"MQCMDL_LEVEL_904"),(905,"MQCMDL_LEVEL_905"),(910,"MQCMDL_LEVEL_910"),(911,"MQCMDL_LEVEL_911"),(912,"MQCMDL_LEVEL_912"),(913,"MQCMDL_LEVEL_913"),(914,"MQCMDL_LEVEL_914"),(915,"MQCMDL_LEVEL_915"),(920,"MQCMDL_LEVEL_920"),(921,"MQCMDL_LEVEL_921"),(922,"MQCMDL_LEVEL_922"),(923,"MQCMDL_LEVEL_923"),(924,"MQCMDL_LEVEL_924"),(925,"MQCMDL_LEVEL_925"),(930,"MQCMDL_LEVEL_930"),(931,"MQCMDL_LEVEL_931"),(932,"MQCMDL_LEVEL_932"),(933,"MQCMDL_LEVEL_933"),(934,"MQCMDL_LEVEL_934"),(935,"MQCMDL_LEVEL_935"),(940,"MQCMDL_LEVEL_940"),(941,"MQCMDL_LEVEL_941"),], &[(941,"MQCMDL_CURRENT_LEVEL"),]);
pub const MQCMD_CONST: BinarySearchSource = ConstSource(BinarySearch(&[(0,"MQCMD_NONE"),(1,"MQCMD_CHANGE_Q_MGR"),(2,"MQCMD_INQUIRE_Q_MGR"),(3,"MQCMD_CHANGE_PROCESS"),(4,"MQCMD_COPY_PROCESS"),(5,"MQCMD_CREATE_PROCESS"),(6,"MQCMD_DELETE_PROCESS"),(7,"MQCMD_INQUIRE_PROCESS"),(8,"MQCMD_CHANGE_Q"),(9,"MQCMD_CLEAR_Q"),(10,"MQCMD_COPY_Q"),(11,"MQCMD_CREATE_Q"),(12,"MQCMD_DELETE_Q"),(13,"MQCMD_INQUIRE_Q"),(16,"MQCMD_REFRESH_Q_MGR"),(17,"MQCMD_RESET_Q_STATS"),(18,"MQCMD_INQUIRE_Q_NAMES"),(19,"MQCMD_INQUIRE_PROCESS_NAMES"),(20,"MQCMD_INQUIRE_CHANNEL_NAMES"),(21,"MQCMD_CHANGE_CHANNEL"),(22,"MQCMD_COPY_CHANNEL"),(23,"MQCMD_CREATE_CHANNEL"),(24,"MQCMD_DELETE_CHANNEL"),(25,"MQCMD_INQUIRE_CHANNEL"),(26,"MQCMD_PING_CHANNEL"),(27,"MQCMD_RESET_CHANNEL"),(28,"MQCMD_START_CHANNEL"),(29,"MQCMD_STOP_CHANNEL"),(30,"MQCMD_START_CHANNEL_INIT"),(31,"MQCMD_START_CHANNEL_LISTENER"),(32,"MQCMD_CHANGE_NAMELIST"),(33,"MQCMD_COPY_NAMELIST"),(34,"MQCMD_CREATE_NAMELIST"),(35,"MQCMD_DELETE_NAMELIST"),(36,"MQCMD_INQUIRE_NAMELIST"),(37,"MQCMD_INQUIRE_NAMELIST_NAMES"),(38,"MQCMD_ESCAPE"),(39,"MQCMD_RESOLVE_CHANNEL"),(40,"MQCMD_PING_Q_MGR"),(41,"MQCMD_INQUIRE_Q_STATUS"),(42,"MQCMD_INQUIRE_CHANNEL_STATUS"),(43,"MQCMD_CONFIG_EVENT"),(44,"MQCMD_Q_MGR_EVENT"),(45,"MQCMD_PERFM_EVENT"),(46,"MQCMD_CHANNEL_EVENT"),(60,"MQCMD_DELETE_PUBLICATION"),(61,"MQCMD_DEREGISTER_PUBLISHER"),(62,"MQCMD_DEREGISTER_SUBSCRIBER"),(63,"MQCMD_PUBLISH"),(64,"MQCMD_REGISTER_PUBLISHER"),(65,"MQCMD_REGISTER_SUBSCRIBER"),(66,"MQCMD_REQUEST_UPDATE"),(67,"MQCMD_BROKER_INTERNAL"),(69,"MQCMD_ACTIVITY_MSG"),(70,"MQCMD_INQUIRE_CLUSTER_Q_MGR"),(71,"MQCMD_RESUME_Q_MGR_CLUSTER"),(72,"MQCMD_SUSPEND_Q_MGR_CLUSTER"),(73,"MQCMD_REFRESH_CLUSTER"),(74,"MQCMD_RESET_CLUSTER"),(75,"MQCMD_TRACE_ROUTE"),(78,"MQCMD_REFRESH_SECURITY"),(79,"MQCMD_CHANGE_AUTH_INFO"),(80,"MQCMD_COPY_AUTH_INFO"),(81,"MQCMD_CREATE_AUTH_INFO"),(82,"MQCMD_DELETE_AUTH_INFO"),(83,"MQCMD_INQUIRE_AUTH_INFO"),(84,"MQCMD_INQUIRE_AUTH_INFO_NAMES"),(85,"MQCMD_INQUIRE_CONNECTION"),(86,"MQCMD_STOP_CONNECTION"),(87,"MQCMD_INQUIRE_AUTH_RECS"),(88,"MQCMD_INQUIRE_ENTITY_AUTH"),(89,"MQCMD_DELETE_AUTH_REC"),(90,"MQCMD_SET_AUTH_REC"),(91,"MQCMD_LOGGER_EVENT"),(92,"MQCMD_RESET_Q_MGR"),(93,"MQCMD_CHANGE_LISTENER"),(94,"MQCMD_COPY_LISTENER"),(95,"MQCMD_CREATE_LISTENER"),(96,"MQCMD_DELETE_LISTENER"),(97,"MQCMD_INQUIRE_LISTENER"),(98,"MQCMD_INQUIRE_LISTENER_STATUS"),(99,"MQCMD_COMMAND_EVENT"),(100,"MQCMD_CHANGE_SECURITY"),(101,"MQCMD_CHANGE_CF_STRUC"),(102,"MQCMD_CHANGE_STG_CLASS"),(103,"MQCMD_CHANGE_TRACE"),(104,"MQCMD_ARCHIVE_LOG"),(105,"MQCMD_BACKUP_CF_STRUC"),(106,"MQCMD_CREATE_BUFFER_POOL"),(107,"MQCMD_CREATE_PAGE_SET"),(108,"MQCMD_CREATE_CF_STRUC"),(109,"MQCMD_CREATE_STG_CLASS"),(110,"MQCMD_COPY_CF_STRUC"),(111,"MQCMD_COPY_STG_CLASS"),(112,"MQCMD_DELETE_CF_STRUC"),(113,"MQCMD_DELETE_STG_CLASS"),(114,"MQCMD_INQUIRE_ARCHIVE"),(115,"MQCMD_INQUIRE_CF_STRUC"),(116,"MQCMD_INQUIRE_CF_STRUC_STATUS"),(117,"MQCMD_INQUIRE_CMD_SERVER"),(118,"MQCMD_INQUIRE_CHANNEL_INIT"),(119,"MQCMD_INQUIRE_QSG"),(120,"MQCMD_INQUIRE_LOG"),(121,"MQCMD_INQUIRE_SECURITY"),(122,"MQCMD_INQUIRE_STG_CLASS"),(123,"MQCMD_INQUIRE_SYSTEM"),(124,"MQCMD_INQUIRE_THREAD"),(125,"MQCMD_INQUIRE_TRACE"),(126,"MQCMD_INQUIRE_USAGE"),(127,"MQCMD_MOVE_Q"),(128,"MQCMD_RECOVER_BSDS"),(129,"MQCMD_RECOVER_CF_STRUC"),(130,"MQCMD_RESET_TPIPE"),(131,"MQCMD_RESOLVE_INDOUBT"),(132,"MQCMD_RESUME_Q_MGR"),(133,"MQCMD_REVERIFY_SECURITY"),(134,"MQCMD_SET_ARCHIVE"),(136,"MQCMD_SET_LOG"),(137,"MQCMD_SET_SYSTEM"),(138,"MQCMD_START_CMD_SERVER"),(139,"MQCMD_START_Q_MGR"),(140,"MQCMD_START_TRACE"),(141,"MQCMD_STOP_CHANNEL_INIT"),(142,"MQCMD_STOP_CHANNEL_LISTENER"),(143,"MQCMD_STOP_CMD_SERVER"),(144,"MQCMD_STOP_Q_MGR"),(145,"MQCMD_STOP_TRACE"),(146,"MQCMD_SUSPEND_Q_MGR"),(147,"MQCMD_INQUIRE_CF_STRUC_NAMES"),(148,"MQCMD_INQUIRE_STG_CLASS_NAMES"),(149,"MQCMD_CHANGE_SERVICE"),(150,"MQCMD_COPY_SERVICE"),(151,"MQCMD_CREATE_SERVICE"),(152,"MQCMD_DELETE_SERVICE"),(153,"MQCMD_INQUIRE_SERVICE"),(154,"MQCMD_INQUIRE_SERVICE_STATUS"),(155,"MQCMD_START_SERVICE"),(156,"MQCMD_STOP_SERVICE"),(157,"MQCMD_DELETE_BUFFER_POOL"),(158,"MQCMD_DELETE_PAGE_SET"),(159,"MQCMD_CHANGE_BUFFER_POOL"),(160,"MQCMD_CHANGE_PAGE_SET"),(161,"MQCMD_INQUIRE_Q_MGR_STATUS"),(162,"MQCMD_CREATE_LOG"),(164,"MQCMD_STATISTICS_MQI"),(165,"MQCMD_STATISTICS_Q"),(166,"MQCMD_STATISTICS_CHANNEL"),(167,"MQCMD_ACCOUNTING_MQI"),(168,"MQCMD_ACCOUNTING_Q"),(169,"MQCMD_INQUIRE_AUTH_SERVICE"),(170,"MQCMD_CHANGE_TOPIC"),(171,"MQCMD_COPY_TOPIC"),(172,"MQCMD_CREATE_TOPIC"),(173,"MQCMD_DELETE_TOPIC"),(174,"MQCMD_INQUIRE_TOPIC"),(175,"MQCMD_INQUIRE_TOPIC_NAMES"),(176,"MQCMD_INQUIRE_SUBSCRIPTION"),(177,"MQCMD_CREATE_SUBSCRIPTION"),(178,"MQCMD_CHANGE_SUBSCRIPTION"),(179,"MQCMD_DELETE_SUBSCRIPTION"),(181,"MQCMD_COPY_SUBSCRIPTION"),(182,"MQCMD_INQUIRE_SUB_STATUS"),(183,"MQCMD_INQUIRE_TOPIC_STATUS"),(184,"MQCMD_CLEAR_TOPIC_STRING"),(185,"MQCMD_INQUIRE_PUBSUB_STATUS"),(186,"MQCMD_INQUIRE_SMDS"),(187,"MQCMD_CHANGE_SMDS"),(188,"MQCMD_RESET_SMDS"),(190,"MQCMD_CREATE_COMM_INFO"),(191,"MQCMD_INQUIRE_COMM_INFO"),(192,"MQCMD_CHANGE_COMM_INFO"),(193,"MQCMD_COPY_COMM_INFO"),(194,"MQCMD_DELETE_COMM_INFO"),(195,"MQCMD_PURGE_CHANNEL"),(196,"MQCMD_MQXR_DIAGNOSTICS"),(197,"MQCMD_START_SMDSCONN"),(198,"MQCMD_STOP_SMDSCONN"),(199,"MQCMD_INQUIRE_SMDSCONN"),(200,"MQCMD_INQUIRE_MQXR_STATUS"),(201,"MQCMD_START_CLIENT_TRACE"),(202,"MQCMD_STOP_CLIENT_TRACE"),(203,"MQCMD_SET_CHLAUTH_REC"),(204,"MQCMD_INQUIRE_CHLAUTH_RECS"),(205,"MQCMD_INQUIRE_PROT_POLICY"),(206,"MQCMD_CREATE_PROT_POLICY"),(207,"MQCMD_DELETE_PROT_POLICY"),(208,"MQCMD_CHANGE_PROT_POLICY"),(209,"MQCMD_ACTIVITY_TRACE"),(213,"MQCMD_RESET_CF_STRUC"),(214,"MQCMD_INQUIRE_XR_CAPABILITY"),(216,"MQCMD_INQUIRE_AMQP_CAPABILITY"),(217,"MQCMD_AMQP_DIAGNOSTICS"),(218,"MQCMD_INTER_Q_MGR_STATUS"),(219,"MQCMD_INTER_Q_MGR_BALANCE"),(220,"MQCMD_INQUIRE_APPL_STATUS"),]), &[(208,"MQCMD_SET_PROT_POLICY"),]);
pub const MQCMHO_CONST: LinearSource = ConstSource(&[(0,"MQCMHO_NONE"),(1,"MQCMHO_NO_VALIDATION"),(2,"MQCMHO_VALIDATE"),], &[(0,"MQCMHO_DEFAULT_VALIDATION"),]);
pub const MQCNO_CONST: LinearSource = ConstSource(&[(0,"MQCNO_NONE"),(1,"MQCNO_FASTPATH_BINDING"),(2,"MQCNO_SERIALIZE_CONN_TAG_Q_MGR"),(4,"MQCNO_SERIALIZE_CONN_TAG_QSG"),(8,"MQCNO_RESTRICT_CONN_TAG_Q_MGR"),(16,"MQCNO_RESTRICT_CONN_TAG_QSG"),(32,"MQCNO_HANDLE_SHARE_NONE"),(64,"MQCNO_HANDLE_SHARE_BLOCK"),(128,"MQCNO_HANDLE_SHARE_NO_BLOCK"),(256,"MQCNO_SHARED_BINDING"),(512,"MQCNO_ISOLATED_BINDING"),(1024,"MQCNO_LOCAL_BINDING"),(2048,"MQCNO_CLIENT_BINDING"),(4096,"MQCNO_ACCOUNTING_MQI_ENABLED"),(8192,"MQCNO_ACCOUNTING_MQI_DISABLED"),(16384,"MQCNO_ACCOUNTING_Q_ENABLED"),(32768,"MQCNO_ACCOUNTING_Q_DISABLED"),(65536,"MQCNO_NO_CONV_SHARING"),(262144,"MQCNO_ALL_CONVS_SHARE"),(524288,"MQCNO_CD_FOR_OUTPUT_ONLY"),(1048576,"MQCNO_USE_CD_SELECTION"),(2097152,"MQCNO_GENERATE_CONN_TAG"),(16777216,"MQCNO_RECONNECT"),(33554432,"MQCNO_RECONNECT_DISABLED"),(67108864,"MQCNO_RECONNECT_Q_MGR"),(134217728,"MQCNO_ACTIVITY_TRACE_ENABLED"),(268435456,"MQCNO_ACTIVITY_TRACE_DISABLED"),], &[(0,"MQCNO_RECONNECT_AS_DEF"),(0,"MQCNO_STANDARD_BINDING"),]);
pub const MQCODL_CONST: LinearSource = ConstSource(&[(-1,"MQCODL_AS_INPUT"),], &[]);
pub const MQCOMPRESS_CONST: LinearSource = ConstSource(&[(-1,"MQCOMPRESS_NOT_AVAILABLE"),(0,"MQCOMPRESS_NONE"),(1,"MQCOMPRESS_RLE"),(2,"MQCOMPRESS_ZLIBFAST"),(4,"MQCOMPRESS_ZLIBHIGH"),(8,"MQCOMPRESS_SYSTEM"),(16,"MQCOMPRESS_LZ4FAST"),(32,"MQCOMPRESS_LZ4HIGH"),(268435455,"MQCOMPRESS_ANY"),], &[]);
pub const MQCOPY_CONST: LinearSource = ConstSource(&[(0,"MQCOPY_NONE"),(1,"MQCOPY_ALL"),(2,"MQCOPY_FORWARD"),(4,"MQCOPY_PUBLISH"),(8,"MQCOPY_REPLY"),(16,"MQCOPY_REPORT"),(22,"MQCOPY_DEFAULT"),], &[]);
pub const MQCO_CONST: LinearSource = ConstSource(&[(0,"MQCO_NONE"),(1,"MQCO_DELETE"),(2,"MQCO_DELETE_PURGE"),(4,"MQCO_KEEP_SUB"),(8,"MQCO_REMOVE_SUB"),(32,"MQCO_QUIESCE"),], &[(0,"MQCO_IMMEDIATE"),]);
pub const MQCQT_CONST: LinearSource = ConstSource(&[(1,"MQCQT_LOCAL_Q"),(2,"MQCQT_ALIAS_Q"),(3,"MQCQT_REMOTE_Q"),(4,"MQCQT_Q_MGR_ALIAS"),], &[]);
pub const MQCRC_CONST: LinearSource = ConstSource(&[(0,"MQCRC_OK"),(1,"MQCRC_CICS_EXEC_ERROR"),(2,"MQCRC_MQ_API_ERROR"),(3,"MQCRC_BRIDGE_ERROR"),(4,"MQCRC_BRIDGE_ABEND"),(5,"MQCRC_APPLICATION_ABEND"),(6,"MQCRC_SECURITY_ERROR"),(7,"MQCRC_PROGRAM_NOT_AVAILABLE"),(8,"MQCRC_BRIDGE_TIMEOUT"),(9,"MQCRC_TRANSID_NOT_AVAILABLE"),], &[]);
pub const MQCSP_CONST: LinearSource = ConstSource(&[(0,"MQCSP_AUTH_NONE"),(1,"MQCSP_AUTH_USER_ID_AND_PWD"),(2,"MQCSP_AUTH_ID_TOKEN"),], &[]);
pub const MQCSRV_CONVERT_CONST: LinearSource = ConstSource(&[(0,"MQCSRV_CONVERT_NO"),(1,"MQCSRV_CONVERT_YES"),], &[]);
pub const MQCSRV_DLQ_CONST: LinearSource = ConstSource(&[(0,"MQCSRV_DLQ_NO"),(1,"MQCSRV_DLQ_YES"),], &[]);
pub const MQCS_CONST: LinearSource = ConstSource(&[(0,"MQCS_NONE"),(1,"MQCS_SUSPENDED_TEMPORARY"),(2,"MQCS_SUSPENDED_USER_ACTION"),(3,"MQCS_SUSPENDED"),(4,"MQCS_STOPPED"),], &[]);
pub const MQCTES_CONST: LinearSource = ConstSource(&[(0,"MQCTES_NOSYNC"),(256,"MQCTES_COMMIT"),(4352,"MQCTES_BACKOUT"),(65536,"MQCTES_ENDTASK"),], &[]);
pub const MQCTLO_CONST: LinearSource = ConstSource(&[(0,"MQCTLO_NONE"),(1,"MQCTLO_THREAD_AFFINITY"),(8192,"MQCTLO_FAIL_IF_QUIESCING"),], &[]);
pub const MQCUOWC_CONST: LinearSource = ConstSource(&[(16,"MQCUOWC_MIDDLE"),(256,"MQCUOWC_COMMIT"),(273,"MQCUOWC_ONLY"),(4352,"MQCUOWC_BACKOUT"),(65536,"MQCUOWC_CONTINUE"),], &[]);
pub const MQDCC_CONST: LinearSource = ConstSource(&[(0,"MQDCC_NONE"),(1,"MQDCC_DEFAULT_CONVERSION"),(2,"MQDCC_FILL_TARGET_BUFFER"),(4,"MQDCC_INT_DEFAULT_CONVERSION"),(16,"MQDCC_SOURCE_ENC_NORMAL"),(32,"MQDCC_SOURCE_ENC_REVERSED"),(240,"MQDCC_SOURCE_ENC_MASK"),(256,"MQDCC_TARGET_ENC_NORMAL"),(512,"MQDCC_TARGET_ENC_REVERSED"),(3840,"MQDCC_TARGET_ENC_MASK"),], &[(0,"MQDCC_SOURCE_ENC_UNDEFINED"),(0,"MQDCC_TARGET_ENC_UNDEFINED"),(16,"MQDCC_SOURCE_ENC_FACTOR"),(32,"MQDCC_SOURCE_ENC_NATIVE"),(256,"MQDCC_TARGET_ENC_FACTOR"),(512,"MQDCC_TARGET_ENC_NATIVE"),]);
pub const MQDC_CONST: LinearSource = ConstSource(&[(1,"MQDC_MANAGED"),(2,"MQDC_PROVIDED"),], &[]);
pub const MQDELO_CONST: LinearSource = ConstSource(&[(0,"MQDELO_NONE"),(4,"MQDELO_LOCAL"),], &[]);
pub const MQDHF_CONST: LinearSource = ConstSource(&[(0,"MQDHF_NONE"),(1,"MQDHF_NEW_MSG_IDS"),], &[]);
pub const MQDISCONNECT_CONST: LinearSource = ConstSource(&[(0,"MQDISCONNECT_NORMAL"),(1,"MQDISCONNECT_IMPLICIT"),(2,"MQDISCONNECT_Q_MGR"),], &[]);
pub const MQDLV_CONST: LinearSource = ConstSource(&[(0,"MQDLV_AS_PARENT"),(1,"MQDLV_ALL"),(2,"MQDLV_ALL_DUR"),(3,"MQDLV_ALL_AVAIL"),], &[]);
pub const MQDL_CONST: LinearSource = ConstSource(&[(0,"MQDL_NOT_SUPPORTED"),(1,"MQDL_SUPPORTED"),], &[]);
pub const MQDMHO_CONST: LinearSource = ConstSource(&[(0,"MQDMHO_NONE"),], &[]);
pub const MQDMPO_CONST: LinearSource = ConstSource(&[(0,"MQDMPO_NONE"),(1,"MQDMPO_DEL_PROP_UNDER_CURSOR"),], &[]);
pub const MQDNSWLM_CONST: LinearSource = ConstSource(&[(0,"MQDNSWLM_NO"),(1,"MQDNSWLM_YES"),], &[]);
pub const MQDOPT_CONST: LinearSource = ConstSource(&[(0,"MQDOPT_RESOLVED"),(1,"MQDOPT_DEFINED"),], &[]);
pub const MQDSB_CONST: LinearSource = ConstSource(&[(0,"MQDSB_DEFAULT"),(1,"MQDSB_8K"),(2,"MQDSB_16K"),(3,"MQDSB_32K"),(4,"MQDSB_64K"),(5,"MQDSB_128K"),(6,"MQDSB_256K"),(7,"MQDSB_512K"),(8,"MQDSB_1M"),], &[(8,"MQDSB_1024K"),]);
pub const MQDSE_CONST: LinearSource = ConstSource(&[(0,"MQDSE_DEFAULT"),(1,"MQDSE_YES"),(2,"MQDSE_NO"),], &[]);
pub const MQEC_CONST: LinearSource = ConstSource(&[(2,"MQEC_MSG_ARRIVED"),(3,"MQEC_WAIT_INTERVAL_EXPIRED"),(4,"MQEC_WAIT_CANCELED"),(5,"MQEC_Q_MGR_QUIESCING"),(6,"MQEC_CONNECTION_QUIESCING"),], &[]);
pub const MQEI_CONST: LinearSource = ConstSource(&[(-1,"MQEI_UNLIMITED"),], &[]);
pub const MQENC_CONST: LinearSource = ConstSource(&[(-4096,"MQENC_RESERVED_MASK"),(-1,"MQENC_AS_PUBLISHED"),(1,"MQENC_INTEGER_NORMAL"),(2,"MQENC_INTEGER_REVERSED"),(15,"MQENC_INTEGER_MASK"),(16,"MQENC_DECIMAL_NORMAL"),(32,"MQENC_DECIMAL_REVERSED"),(240,"MQENC_DECIMAL_MASK"),(256,"MQENC_FLOAT_IEEE_NORMAL"),(273,"MQENC_NORMAL"),(512,"MQENC_FLOAT_IEEE_REVERSED"),(546,"MQENC_REVERSED"),(768,"MQENC_FLOAT_S390"),(785,"MQENC_S390"),(1024,"MQENC_FLOAT_TNS"),(1041,"MQENC_TNS"),(3840,"MQENC_FLOAT_MASK"),], &[(0,"MQENC_DECIMAL_UNDEFINED"),(0,"MQENC_FLOAT_UNDEFINED"),(0,"MQENC_INTEGER_UNDEFINED"),(546,"MQENC_NATIVE"),]);
pub const MQEPH_CONST: LinearSource = ConstSource(&[(0,"MQEPH_NONE"),(1,"MQEPH_CCSID_EMBEDDED"),], &[]);
pub const MQET_CONST: LinearSource = ConstSource(&[(1,"MQET_MQSC"),], &[]);
pub const MQEVO_CONST: LinearSource = ConstSource(&[(0,"MQEVO_OTHER"),(1,"MQEVO_CONSOLE"),(2,"MQEVO_INIT"),(3,"MQEVO_MSG"),(4,"MQEVO_MQSET"),(5,"MQEVO_INTERNAL"),(6,"MQEVO_MQSUB"),(7,"MQEVO_CTLMSG"),(8,"MQEVO_REST"),], &[]);
pub const MQEVR_CONST: LinearSource = ConstSource(&[(0,"MQEVR_DISABLED"),(1,"MQEVR_ENABLED"),(2,"MQEVR_EXCEPTION"),(3,"MQEVR_NO_DISPLAY"),(4,"MQEVR_API_ONLY"),(5,"MQEVR_ADMIN_ONLY"),(6,"MQEVR_USER_ONLY"),], &[]);
pub const MQEXPI_CONST: LinearSource = ConstSource(&[(0,"MQEXPI_OFF"),], &[]);
pub const MQEXTATTRS_CONST: LinearSource = ConstSource(&[(0,"MQEXTATTRS_ALL"),(1,"MQEXTATTRS_NONDEF"),], &[]);
pub const MQEXT_CONST: LinearSource = ConstSource(&[(0,"MQEXT_ALL"),(1,"MQEXT_OBJECT"),(2,"MQEXT_AUTHORITY"),], &[]);
pub const MQFB_CONST: LinearSource = ConstSource(&[(0,"MQFB_NONE"),(256,"MQFB_QUIT"),(258,"MQFB_EXPIRATION"),(259,"MQFB_COA"),(260,"MQFB_COD"),(262,"MQFB_CHANNEL_COMPLETED"),(263,"MQFB_CHANNEL_FAIL_RETRY"),(264,"MQFB_CHANNEL_FAIL"),(265,"MQFB_APPL_CANNOT_BE_STARTED"),(266,"MQFB_TM_ERROR"),(267,"MQFB_APPL_TYPE_ERROR"),(268,"MQFB_STOPPED_BY_MSG_EXIT"),(269,"MQFB_ACTIVITY"),(271,"MQFB_XMIT_Q_MSG_ERROR"),(275,"MQFB_PAN"),(276,"MQFB_NAN"),(277,"MQFB_STOPPED_BY_CHAD_EXIT"),(279,"MQFB_STOPPED_BY_PUBSUB_EXIT"),(280,"MQFB_NOT_A_REPOSITORY_MSG"),(281,"MQFB_BIND_OPEN_CLUSRCVR_DEL"),(282,"MQFB_MAX_ACTIVITIES"),(283,"MQFB_NOT_FORWARDED"),(284,"MQFB_NOT_DELIVERED"),(285,"MQFB_UNSUPPORTED_FORWARDING"),(286,"MQFB_UNSUPPORTED_DELIVERY"),(291,"MQFB_DATA_LENGTH_ZERO"),(292,"MQFB_DATA_LENGTH_NEGATIVE"),(293,"MQFB_DATA_LENGTH_TOO_BIG"),(294,"MQFB_BUFFER_OVERFLOW"),(295,"MQFB_LENGTH_OFF_BY_ONE"),(296,"MQFB_IIH_ERROR"),(298,"MQFB_NOT_AUTHORIZED_FOR_IMS"),(299,"MQFB_DATA_LENGTH_TOO_SHORT"),(300,"MQFB_IMS_ERROR"),(401,"MQFB_CICS_INTERNAL_ERROR"),(402,"MQFB_CICS_NOT_AUTHORIZED"),(403,"MQFB_CICS_BRIDGE_FAILURE"),(404,"MQFB_CICS_CORREL_ID_ERROR"),(405,"MQFB_CICS_CCSID_ERROR"),(406,"MQFB_CICS_ENCODING_ERROR"),(407,"MQFB_CICS_CIH_ERROR"),(408,"MQFB_CICS_UOW_ERROR"),(409,"MQFB_CICS_COMMAREA_ERROR"),(410,"MQFB_CICS_APPL_NOT_STARTED"),(411,"MQFB_CICS_APPL_ABENDED"),(412,"MQFB_CICS_DLQ_ERROR"),(413,"MQFB_CICS_UOW_BACKED_OUT"),(501,"MQFB_PUBLICATIONS_ON_REQUEST"),(502,"MQFB_SUBSCRIBER_IS_PUBLISHER"),(503,"MQFB_MSG_SCOPE_MISMATCH"),(504,"MQFB_SELECTOR_MISMATCH"),(505,"MQFB_NOT_A_GROUPUR_MSG"),], &[]);
pub const MQFC_CONST: LinearSource = ConstSource(&[(0,"MQFC_NO"),(1,"MQFC_YES"),], &[]);
pub const MQFIELD_WQR_CONST: LinearSource = ConstSource(&[(8000,"MQFIELD_WQR_StrucId"),(8001,"MQFIELD_WQR_Version"),(8002,"MQFIELD_WQR_StrucLength"),(8003,"MQFIELD_WQR_QFlags"),(8004,"MQFIELD_WQR_QName"),(8005,"MQFIELD_WQR_QMgrIdentifier"),(8006,"MQFIELD_WQR_ClusterRecOffset"),(8007,"MQFIELD_WQR_QType"),(8008,"MQFIELD_WQR_QDesc"),(8009,"MQFIELD_WQR_DefBind"),(8010,"MQFIELD_WQR_DefPersistence"),(8011,"MQFIELD_WQR_DefPriority"),(8012,"MQFIELD_WQR_InhibitPut"),(8013,"MQFIELD_WQR_CLWLQueuePriority"),(8014,"MQFIELD_WQR_CLWLQueueRank"),(8015,"MQFIELD_WQR_DefPutResponse"),(8016,"MQFIELD_WQR_CapExpiry"),], &[]);
pub const MQFSENC_CONST: LinearSource = ConstSource(&[(0,"MQFSENC_NO"),(1,"MQFSENC_YES"),(2,"MQFSENC_UNKNOWN"),], &[]);
pub const MQFS_CONST: LinearSource = ConstSource(&[(-1,"MQFS_SHARED"),], &[]);
pub const MQFUN_CONST: LinearSource = ConstSource(&[(0,"MQFUN_TYPE_UNKNOWN"),(1,"MQFUN_TYPE_JVM"),(2,"MQFUN_TYPE_PROGRAM"),(3,"MQFUN_TYPE_PROCEDURE"),(4,"MQFUN_TYPE_USERDEF"),(5,"MQFUN_TYPE_COMMAND"),], &[]);
pub const MQGACF_CONST: LinearSource = ConstSource(&[(8001,"MQGACF_COMMAND_CONTEXT"),(8002,"MQGACF_COMMAND_DATA"),(8003,"MQGACF_TRACE_ROUTE"),(8004,"MQGACF_OPERATION"),(8005,"MQGACF_ACTIVITY"),(8006,"MQGACF_EMBEDDED_MQMD"),(8007,"MQGACF_MESSAGE"),(8008,"MQGACF_MQMD"),(8009,"MQGACF_VALUE_NAMING"),(8010,"MQGACF_Q_ACCOUNTING_DATA"),(8011,"MQGACF_Q_STATISTICS_DATA"),(8012,"MQGACF_CHL_STATISTICS_DATA"),(8013,"MQGACF_ACTIVITY_TRACE"),(8014,"MQGACF_APP_DIST_LIST"),(8015,"MQGACF_MONITOR_CLASS"),(8016,"MQGACF_MONITOR_TYPE"),(8017,"MQGACF_MONITOR_ELEMENT"),(8018,"MQGACF_APPL_STATUS"),(8019,"MQGACF_CHANGED_APPLS"),(8020,"MQGACF_ALL_APPLS"),(8021,"MQGACF_APPL_BALANCE"),], &[]);
pub const MQGMO_CONST: LinearSource = ConstSource(&[(0,"MQGMO_NONE"),(1,"MQGMO_WAIT"),(2,"MQGMO_SYNCPOINT"),(4,"MQGMO_NO_SYNCPOINT"),(8,"MQGMO_SET_SIGNAL"),(16,"MQGMO_BROWSE_FIRST"),(32,"MQGMO_BROWSE_NEXT"),(64,"MQGMO_ACCEPT_TRUNCATED_MSG"),(128,"MQGMO_MARK_SKIP_BACKOUT"),(256,"MQGMO_MSG_UNDER_CURSOR"),(512,"MQGMO_LOCK"),(1024,"MQGMO_UNLOCK"),(2048,"MQGMO_BROWSE_MSG_UNDER_CURSOR"),(4096,"MQGMO_SYNCPOINT_IF_PERSISTENT"),(8192,"MQGMO_FAIL_IF_QUIESCING"),(16384,"MQGMO_CONVERT"),(32768,"MQGMO_LOGICAL_ORDER"),(65536,"MQGMO_COMPLETE_MSG"),(131072,"MQGMO_ALL_MSGS_AVAILABLE"),(262144,"MQGMO_ALL_SEGMENTS_AVAILABLE"),(1048576,"MQGMO_MARK_BROWSE_HANDLE"),(2097152,"MQGMO_MARK_BROWSE_CO_OP"),(4194304,"MQGMO_UNMARK_BROWSE_CO_OP"),(8388608,"MQGMO_UNMARK_BROWSE_HANDLE"),(16777216,"MQGMO_UNMARKED_BROWSE_MSG"),(17825808,"MQGMO_BROWSE_HANDLE"),(18874384,"MQGMO_BROWSE_CO_OP"),(33554432,"MQGMO_PROPERTIES_FORCE_MQRFH2"),(67108864,"MQGMO_NO_PROPERTIES"),(134217728,"MQGMO_PROPERTIES_IN_HANDLE"),(268435456,"MQGMO_PROPERTIES_COMPATIBILITY"),], &[(0,"MQGMO_NO_WAIT"),(0,"MQGMO_PROPERTIES_AS_Q_DEF"),]);
pub const MQGUR_CONST: LinearSource = ConstSource(&[(0,"MQGUR_DISABLED"),(1,"MQGUR_ENABLED"),], &[]);
pub const MQHA_CONST: LinearSource = ConstSource(&[(4001,"MQHA_BAG_HANDLE"),], &[]);
pub const MQHB_CONST: LinearSource = ConstSource(&[(-2,"MQHB_NONE"),(-1,"MQHB_UNUSABLE_HBAG"),], &[]);
pub const MQHC_CONST: LinearSource = ConstSource(&[(-3,"MQHC_UNASSOCIATED_HCONN"),(-1,"MQHC_UNUSABLE_HCONN"),(0,"MQHC_DEF_HCONN"),], &[]);
pub const MQHM_CONST: LinearSource = ConstSource(&[(-1,"MQHM_UNUSABLE_HMSG"),(0,"MQHM_NONE"),], &[]);
pub const MQHO_CONST: LinearSource = ConstSource(&[(-1,"MQHO_UNUSABLE_HOBJ"),(0,"MQHO_NONE"),], &[]);
pub const MQHSTATE_CONST: LinearSource = ConstSource(&[(0,"MQHSTATE_INACTIVE"),(1,"MQHSTATE_ACTIVE"),], &[]);
pub const MQIACF_CONST: PhfSource = ConstSource(&::phf::Map {
...
}, &[(1008,"MQIACF_MODE"),(1013,"MQIACF_ERROR_IDENTIFIER"),(1199,"MQIACF_SYSP_SMF_STAT_TIME_MINS"),]);
pub const MQIACH_CONST: BinarySearchSource = ConstSource(BinarySearch(&[(1501,"MQIACH_XMIT_PROTOCOL_TYPE"),(1502,"MQIACH_BATCH_SIZE"),(1503,"MQIACH_DISC_INTERVAL"),(1504,"MQIACH_SHORT_TIMER"),(1505,"MQIACH_SHORT_RETRY"),(1506,"MQIACH_LONG_TIMER"),(1507,"MQIACH_LONG_RETRY"),(1508,"MQIACH_PUT_AUTHORITY"),(1509,"MQIACH_SEQUENCE_NUMBER_WRAP"),(1510,"MQIACH_MAX_MSG_LENGTH"),(1511,"MQIACH_CHANNEL_TYPE"),(1512,"MQIACH_DATA_COUNT"),(1513,"MQIACH_NAME_COUNT"),(1514,"MQIACH_MSG_SEQUENCE_NUMBER"),(1515,"MQIACH_DATA_CONVERSION"),(1516,"MQIACH_IN_DOUBT"),(1517,"MQIACH_MCA_TYPE"),(1518,"MQIACH_SESSION_COUNT"),(1519,"MQIACH_ADAPTER"),(1520,"MQIACH_COMMAND_COUNT"),(1521,"MQIACH_SOCKET"),(1522,"MQIACH_PORT"),(1523,"MQIACH_CHANNEL_INSTANCE_TYPE"),(1524,"MQIACH_CHANNEL_INSTANCE_ATTRS"),(1525,"MQIACH_CHANNEL_ERROR_DATA"),(1526,"MQIACH_CHANNEL_TABLE"),(1527,"MQIACH_CHANNEL_STATUS"),(1528,"MQIACH_INDOUBT_STATUS"),(1529,"MQIACH_LAST_SEQ_NUMBER"),(1531,"MQIACH_CURRENT_MSGS"),(1532,"MQIACH_CURRENT_SEQ_NUMBER"),(1533,"MQIACH_SSL_RETURN_CODE"),(1534,"MQIACH_MSGS"),(1535,"MQIACH_BYTES_SENT"),(1536,"MQIACH_BYTES_RCVD"),(1537,"MQIACH_BATCHES"),(1538,"MQIACH_BUFFERS_SENT"),(1539,"MQIACH_BUFFERS_RCVD"),(1540,"MQIACH_LONG_RETRIES_LEFT"),(1541,"MQIACH_SHORT_RETRIES_LEFT"),(1542,"MQIACH_MCA_STATUS"),(1543,"MQIACH_STOP_REQUESTED"),(1544,"MQIACH_MR_COUNT"),(1545,"MQIACH_MR_INTERVAL"),(1562,"MQIACH_NPM_SPEED"),(1563,"MQIACH_HB_INTERVAL"),(1564,"MQIACH_BATCH_INTERVAL"),(1565,"MQIACH_NETWORK_PRIORITY"),(1566,"MQIACH_KEEP_ALIVE_INTERVAL"),(1567,"MQIACH_BATCH_HB"),(1568,"MQIACH_SSL_CLIENT_AUTH"),(1570,"MQIACH_ALLOC_RETRY"),(1571,"MQIACH_ALLOC_FAST_TIMER"),(1572,"MQIACH_ALLOC_SLOW_TIMER"),(1573,"MQIACH_DISC_RETRY"),(1574,"MQIACH_PORT_NUMBER"),(1575,"MQIACH_HDR_COMPRESSION"),(1576,"MQIACH_MSG_COMPRESSION"),(1577,"MQIACH_CLWL_CHANNEL_RANK"),(1578,"MQIACH_CLWL_CHANNEL_PRIORITY"),(1579,"MQIACH_CLWL_CHANNEL_WEIGHT"),(1580,"MQIACH_CHANNEL_DISP"),(1581,"MQIACH_INBOUND_DISP"),(1582,"MQIACH_CHANNEL_TYPES"),(1583,"MQIACH_ADAPS_STARTED"),(1584,"MQIACH_ADAPS_MAX"),(1585,"MQIACH_DISPS_STARTED"),(1586,"MQIACH_DISPS_MAX"),(1587,"MQIACH_SSLTASKS_STARTED"),(1588,"MQIACH_SSLTASKS_MAX"),(1589,"MQIACH_CURRENT_CHL"),(1590,"MQIACH_CURRENT_CHL_MAX"),(1591,"MQIACH_CURRENT_CHL_TCP"),(1592,"MQIACH_CURRENT_CHL_LU62"),(1593,"MQIACH_ACTIVE_CHL"),(1594,"MQIACH_ACTIVE_CHL_MAX"),(1595,"MQIACH_ACTIVE_CHL_PAUSED"),(1596,"MQIACH_ACTIVE_CHL_STARTED"),(1597,"MQIACH_ACTIVE_CHL_STOPPED"),(1598,"MQIACH_ACTIVE_CHL_RETRY"),(1599,"MQIACH_LISTENER_STATUS"),(1600,"MQIACH_SHARED_CHL_RESTART"),(1601,"MQIACH_LISTENER_CONTROL"),(1602,"MQIACH_BACKLOG"),(1604,"MQIACH_XMITQ_TIME_INDICATOR"),(1605,"MQIACH_NETWORK_TIME_INDICATOR"),(1606,"MQIACH_EXIT_TIME_INDICATOR"),(1607,"MQIACH_BATCH_SIZE_INDICATOR"),(1608,"MQIACH_XMITQ_MSGS_AVAILABLE"),(1609,"MQIACH_CHANNEL_SUBSTATE"),(1610,"MQIACH_SSL_KEY_RESETS"),(1611,"MQIACH_COMPRESSION_RATE"),(1612,"MQIACH_COMPRESSION_TIME"),(1613,"MQIACH_MAX_XMIT_SIZE"),(1614,"MQIACH_DEF_CHANNEL_DISP"),(1615,"MQIACH_SHARING_CONVERSATIONS"),(1616,"MQIACH_MAX_SHARING_CONVS"),(1617,"MQIACH_CURRENT_SHARING_CONVS"),(1618,"MQIACH_MAX_INSTANCES"),(1619,"MQIACH_MAX_INSTS_PER_CLIENT"),(1620,"MQIACH_CLIENT_CHANNEL_WEIGHT"),(1621,"MQIACH_CONNECTION_AFFINITY"),(1622,"MQIACH_AUTH_INFO_TYPES"),(1623,"MQIACH_RESET_REQUESTED"),(1624,"MQIACH_BATCH_DATA_LIMIT"),(1625,"MQIACH_MSG_HISTORY"),(1626,"MQIACH_MULTICAST_PROPERTIES"),(1627,"MQIACH_NEW_SUBSCRIBER_HISTORY"),(1628,"MQIACH_MC_HB_INTERVAL"),(1629,"MQIACH_USE_CLIENT_ID"),(1630,"MQIACH_MQTT_KEEP_ALIVE"),(1631,"MQIACH_IN_DOUBT_IN"),(1632,"MQIACH_IN_DOUBT_OUT"),(1633,"MQIACH_MSGS_SENT"),(1634,"MQIACH_MSGS_RCVD"),(1635,"MQIACH_PENDING_OUT"),(1636,"MQIACH_AVAILABLE_CIPHERSPECS"),(1637,"MQIACH_MATCH"),(1638,"MQIACH_USER_SOURCE"),(1639,"MQIACH_WARNING"),(1640,"MQIACH_DEF_RECONNECT"),(1642,"MQIACH_CHANNEL_SUMMARY_ATTRS"),(1643,"MQIACH_PROTOCOL"),(1644,"MQIACH_AMQP_KEEP_ALIVE"),(1645,"MQIACH_SECURITY_PROTOCOL"),(1646,"MQIACH_SPL_PROTECTION"),]), &[(1529,"MQIACH_LAST_SEQUENCE_NUMBER"),(1532,"MQIACH_CURRENT_SEQUENCE_NUMBER"),(1536,"MQIACH_BYTES_RECEIVED"),(1539,"MQIACH_BUFFERS_RECEIVED"),(1634,"MQIACH_MSGS_RECEIVED"),]);
pub const MQIAMO64_CONST: LinearSource = ConstSource(&[(703,"MQIAMO64_AVG_Q_TIME"),(741,"MQIAMO64_Q_TIME_AVG"),(742,"MQIAMO64_Q_TIME_MAX"),(743,"MQIAMO64_Q_TIME_MIN"),(745,"MQIAMO64_BROWSE_BYTES"),(746,"MQIAMO64_BYTES"),(747,"MQIAMO64_GET_BYTES"),(748,"MQIAMO64_PUT_BYTES"),(783,"MQIAMO64_TOPIC_PUT_BYTES"),(785,"MQIAMO64_PUBLISH_MSG_BYTES"),(838,"MQIAMO64_HIGHRES_TIME"),(844,"MQIAMO64_QMGR_OP_DURATION"),(845,"MQIAMO64_MONITOR_INTERVAL"),], &[]);
pub const MQIAMO_CONST: BinarySearchSource = ConstSource(BinarySearch(&[(702,"MQIAMO_AVG_BATCH_SIZE"),(703,"MQIAMO_AVG_Q_TIME"),(704,"MQIAMO_BACKOUTS"),(705,"MQIAMO_BROWSES"),(706,"MQIAMO_BROWSE_MAX_BYTES"),(707,"MQIAMO_BROWSE_MIN_BYTES"),(708,"MQIAMO_BROWSES_FAILED"),(709,"MQIAMO_CLOSES"),(710,"MQIAMO_COMMITS"),(711,"MQIAMO_COMMITS_FAILED"),(712,"MQIAMO_CONNS"),(713,"MQIAMO_CONNS_MAX"),(714,"MQIAMO_DISCS"),(715,"MQIAMO_DISCS_IMPLICIT"),(716,"MQIAMO_DISC_TYPE"),(717,"MQIAMO_EXIT_TIME_AVG"),(718,"MQIAMO_EXIT_TIME_MAX"),(719,"MQIAMO_EXIT_TIME_MIN"),(720,"MQIAMO_FULL_BATCHES"),(721,"MQIAMO_GENERATED_MSGS"),(722,"MQIAMO_GETS"),(723,"MQIAMO_GET_MAX_BYTES"),(724,"MQIAMO_GET_MIN_BYTES"),(725,"MQIAMO_GETS_FAILED"),(726,"MQIAMO_INCOMPLETE_BATCHES"),(727,"MQIAMO_INQS"),(728,"MQIAMO_MSGS"),(729,"MQIAMO_NET_TIME_AVG"),(730,"MQIAMO_NET_TIME_MAX"),(731,"MQIAMO_NET_TIME_MIN"),(732,"MQIAMO_OBJECT_COUNT"),(733,"MQIAMO_OPENS"),(734,"MQIAMO_PUT1S"),(735,"MQIAMO_PUTS"),(736,"MQIAMO_PUT_MAX_BYTES"),(737,"MQIAMO_PUT_MIN_BYTES"),(738,"MQIAMO_PUT_RETRIES"),(739,"MQIAMO_Q_MAX_DEPTH"),(740,"MQIAMO_Q_MIN_DEPTH"),(741,"MQIAMO_Q_TIME_AVG"),(742,"MQIAMO_Q_TIME_MAX"),(743,"MQIAMO_Q_TIME_MIN"),(744,"MQIAMO_SETS"),(749,"MQIAMO_CONNS_FAILED"),(751,"MQIAMO_OPENS_FAILED"),(752,"MQIAMO_INQS_FAILED"),(753,"MQIAMO_SETS_FAILED"),(754,"MQIAMO_PUTS_FAILED"),(755,"MQIAMO_PUT1S_FAILED"),(757,"MQIAMO_CLOSES_FAILED"),(758,"MQIAMO_MSGS_EXPIRED"),(759,"MQIAMO_MSGS_NOT_QUEUED"),(760,"MQIAMO_MSGS_PURGED"),(764,"MQIAMO_SUBS_DUR"),(765,"MQIAMO_SUBS_NDUR"),(766,"MQIAMO_SUBS_FAILED"),(767,"MQIAMO_SUBRQS"),(768,"MQIAMO_SUBRQS_FAILED"),(769,"MQIAMO_CBS"),(770,"MQIAMO_CBS_FAILED"),(771,"MQIAMO_CTLS"),(772,"MQIAMO_CTLS_FAILED"),(773,"MQIAMO_STATS"),(774,"MQIAMO_STATS_FAILED"),(775,"MQIAMO_SUB_DUR_HIGHWATER"),(776,"MQIAMO_SUB_DUR_LOWWATER"),(777,"MQIAMO_SUB_NDUR_HIGHWATER"),(778,"MQIAMO_SUB_NDUR_LOWWATER"),(779,"MQIAMO_TOPIC_PUTS"),(780,"MQIAMO_TOPIC_PUTS_FAILED"),(781,"MQIAMO_TOPIC_PUT1S"),(782,"MQIAMO_TOPIC_PUT1S_FAILED"),(784,"MQIAMO_PUBLISH_MSG_COUNT"),(786,"MQIAMO_UNSUBS_DUR"),(787,"MQIAMO_UNSUBS_NDUR"),(788,"MQIAMO_UNSUBS_FAILED"),(789,"MQIAMO_INTERVAL"),(790,"MQIAMO_MSGS_SENT"),(791,"MQIAMO_BYTES_SENT"),(792,"MQIAMO_REPAIR_BYTES"),(793,"MQIAMO_FEEDBACK_MODE"),(794,"MQIAMO_RELIABILITY_TYPE"),(795,"MQIAMO_LATE_JOIN_MARK"),(796,"MQIAMO_NACKS_RCVD"),(797,"MQIAMO_REPAIR_PKTS"),(798,"MQIAMO_HISTORY_PKTS"),(799,"MQIAMO_PENDING_PKTS"),(800,"MQIAMO_PKT_RATE"),(801,"MQIAMO_MCAST_XMIT_RATE"),(802,"MQIAMO_MCAST_BATCH_TIME"),(803,"MQIAMO_MCAST_HEARTBEAT"),(804,"MQIAMO_DEST_DATA_PORT"),(805,"MQIAMO_DEST_REPAIR_PORT"),(806,"MQIAMO_ACKS_RCVD"),(807,"MQIAMO_ACTIVE_ACKERS"),(808,"MQIAMO_PKTS_SENT"),(809,"MQIAMO_TOTAL_REPAIR_PKTS"),(810,"MQIAMO_TOTAL_PKTS_SENT"),(811,"MQIAMO_TOTAL_MSGS_SENT"),(812,"MQIAMO_TOTAL_BYTES_SENT"),(813,"MQIAMO_NUM_STREAMS"),(814,"MQIAMO_ACK_FEEDBACK"),(815,"MQIAMO_NACK_FEEDBACK"),(816,"MQIAMO_PKTS_LOST"),(817,"MQIAMO_MSGS_RCVD"),(818,"MQIAMO_MSG_BYTES_RCVD"),(819,"MQIAMO_MSGS_DELIVERED"),(820,"MQIAMO_PKTS_PROCESSED"),(821,"MQIAMO_PKTS_DELIVERED"),(822,"MQIAMO_PKTS_DROPPED"),(823,"MQIAMO_PKTS_DUPLICATED"),(824,"MQIAMO_NACKS_CREATED"),(825,"MQIAMO_NACK_PKTS_SENT"),(826,"MQIAMO_REPAIR_PKTS_RQSTD"),(827,"MQIAMO_REPAIR_PKTS_RCVD"),(828,"MQIAMO_PKTS_REPAIRED"),(829,"MQIAMO_TOTAL_MSGS_RCVD"),(830,"MQIAMO_TOTAL_MSG_BYTES_RCVD"),(831,"MQIAMO_TOTAL_REPAIR_PKTS_RCVD"),(832,"MQIAMO_TOTAL_REPAIR_PKTS_RQSTD"),(833,"MQIAMO_TOTAL_MSGS_PROCESSED"),(834,"MQIAMO_TOTAL_MSGS_SELECTED"),(835,"MQIAMO_TOTAL_MSGS_EXPIRED"),(836,"MQIAMO_TOTAL_MSGS_DELIVERED"),(837,"MQIAMO_TOTAL_MSGS_RETURNED"),(839,"MQIAMO_MONITOR_CLASS"),(840,"MQIAMO_MONITOR_TYPE"),(841,"MQIAMO_MONITOR_ELEMENT"),(842,"MQIAMO_MONITOR_DATATYPE"),(843,"MQIAMO_MONITOR_FLAGS"),]), &[]);
pub const MQIAMO_MONITOR_DATATYPE_CONST: LinearSource = ConstSource(&[(1,"MQIAMO_MONITOR_UNIT"),(2,"MQIAMO_MONITOR_DELTA"),(100,"MQIAMO_MONITOR_HUNDREDTHS"),(1024,"MQIAMO_MONITOR_KB"),(10000,"MQIAMO_MONITOR_PERCENT"),(1000000,"MQIAMO_MONITOR_MICROSEC"),(1048576,"MQIAMO_MONITOR_MB"),(100000000,"MQIAMO_MONITOR_GB"),], &[]);
pub const MQIAMO_MONITOR_FLAGS_CONST: LinearSource = ConstSource(&[(0,"MQIAMO_MONITOR_FLAGS_NONE"),(1,"MQIAMO_MONITOR_FLAGS_OBJNAME"),], &[]);
pub const MQIASY_CONST: LinearSource = ConstSource(&[(-9,"MQIASY_VERSION"),(-8,"MQIASY_BAG_OPTIONS"),(-7,"MQIASY_REASON"),(-6,"MQIASY_COMP_CODE"),(-5,"MQIASY_CONTROL"),(-4,"MQIASY_MSG_SEQ_NUMBER"),(-3,"MQIASY_COMMAND"),(-2,"MQIASY_TYPE"),(-1,"MQIASY_CODED_CHAR_SET_ID"),], &[]);
pub const MQIAV_CONST: LinearSource = ConstSource(&[(-2,"MQIAV_UNDEFINED"),(-1,"MQIAV_NOT_APPLICABLE"),], &[]);
pub const MQIA_CONST: BinarySearchSource = ConstSource(BinarySearch(&[(1,"MQIA_APPL_TYPE"),(2,"MQIA_CODED_CHAR_SET_ID"),(3,"MQIA_CURRENT_Q_DEPTH"),(4,"MQIA_DEF_INPUT_OPEN_OPTION"),(5,"MQIA_DEF_PERSISTENCE"),(6,"MQIA_DEF_PRIORITY"),(7,"MQIA_DEFINITION_TYPE"),(8,"MQIA_HARDEN_GET_BACKOUT"),(9,"MQIA_INHIBIT_GET"),(10,"MQIA_INHIBIT_PUT"),(11,"MQIA_MAX_HANDLES"),(12,"MQIA_USAGE"),(13,"MQIA_MAX_MSG_LENGTH"),(14,"MQIA_MAX_PRIORITY"),(15,"MQIA_MAX_Q_DEPTH"),(16,"MQIA_MSG_DELIVERY_SEQUENCE"),(17,"MQIA_OPEN_INPUT_COUNT"),(18,"MQIA_OPEN_OUTPUT_COUNT"),(19,"MQIA_NAME_COUNT"),(20,"MQIA_Q_TYPE"),(21,"MQIA_RETENTION_INTERVAL"),(22,"MQIA_BACKOUT_THRESHOLD"),(23,"MQIA_SHAREABILITY"),(24,"MQIA_TRIGGER_CONTROL"),(25,"MQIA_TRIGGER_INTERVAL"),(26,"MQIA_TRIGGER_MSG_PRIORITY"),(27,"MQIA_CPI_LEVEL"),(28,"MQIA_TRIGGER_TYPE"),(29,"MQIA_TRIGGER_DEPTH"),(30,"MQIA_SYNCPOINT"),(31,"MQIA_COMMAND_LEVEL"),(32,"MQIA_PLATFORM"),(33,"MQIA_MAX_UNCOMMITTED_MSGS"),(34,"MQIA_DIST_LISTS"),(35,"MQIA_TIME_SINCE_RESET"),(36,"MQIA_HIGH_Q_DEPTH"),(37,"MQIA_MSG_ENQ_COUNT"),(38,"MQIA_MSG_DEQ_COUNT"),(39,"MQIA_EXPIRY_INTERVAL"),(40,"MQIA_Q_DEPTH_HIGH_LIMIT"),(41,"MQIA_Q_DEPTH_LOW_LIMIT"),(42,"MQIA_Q_DEPTH_MAX_EVENT"),(43,"MQIA_Q_DEPTH_HIGH_EVENT"),(44,"MQIA_Q_DEPTH_LOW_EVENT"),(45,"MQIA_SCOPE"),(46,"MQIA_Q_SERVICE_INTERVAL_EVENT"),(47,"MQIA_AUTHORITY_EVENT"),(48,"MQIA_INHIBIT_EVENT"),(49,"MQIA_LOCAL_EVENT"),(50,"MQIA_REMOTE_EVENT"),(51,"MQIA_CONFIGURATION_EVENT"),(52,"MQIA_START_STOP_EVENT"),(53,"MQIA_PERFORMANCE_EVENT"),(54,"MQIA_Q_SERVICE_INTERVAL"),(55,"MQIA_CHANNEL_AUTO_DEF"),(56,"MQIA_CHANNEL_AUTO_DEF_EVENT"),(57,"MQIA_INDEX_TYPE"),(58,"MQIA_CLUSTER_WORKLOAD_LENGTH"),(59,"MQIA_CLUSTER_Q_TYPE"),(60,"MQIA_ARCHIVE"),(61,"MQIA_DEF_BIND"),(62,"MQIA_PAGESET_ID"),(63,"MQIA_QSG_DISP"),(64,"MQIA_INTRA_GROUP_QUEUING"),(65,"MQIA_IGQ_PUT_AUTHORITY"),(66,"MQIA_AUTH_INFO_TYPE"),(68,"MQIA_MSG_MARK_BROWSE_INTERVAL"),(69,"MQIA_SSL_TASKS"),(70,"MQIA_CF_LEVEL"),(71,"MQIA_CF_RECOVER"),(72,"MQIA_NAMELIST_TYPE"),(73,"MQIA_CHANNEL_EVENT"),(74,"MQIA_BRIDGE_EVENT"),(75,"MQIA_SSL_EVENT"),(76,"MQIA_SSL_RESET_COUNT"),(77,"MQIA_SHARED_Q_Q_MGR_NAME"),(78,"MQIA_NPM_CLASS"),(80,"MQIA_MAX_OPEN_Q"),(81,"MQIA_MONITOR_INTERVAL"),(82,"MQIA_Q_USERS"),(83,"MQIA_MAX_GLOBAL_LOCKS"),(84,"MQIA_MAX_LOCAL_LOCKS"),(85,"MQIA_LISTENER_PORT_NUMBER"),(86,"MQIA_BATCH_INTERFACE_AUTO"),(87,"MQIA_CMD_SERVER_AUTO"),(88,"MQIA_CMD_SERVER_CONVERT_MSG"),(89,"MQIA_CMD_SERVER_DLQ_MSG"),(90,"MQIA_MAX_Q_TRIGGERS"),(91,"MQIA_TRIGGER_RESTART"),(92,"MQIA_SSL_FIPS_REQUIRED"),(93,"MQIA_IP_ADDRESS_VERSION"),(94,"MQIA_LOGGER_EVENT"),(95,"MQIA_CLWL_Q_RANK"),(96,"MQIA_CLWL_Q_PRIORITY"),(97,"MQIA_CLWL_MRU_CHANNELS"),(98,"MQIA_CLWL_USEQ"),(99,"MQIA_COMMAND_EVENT"),(100,"MQIA_ACTIVE_CHANNELS"),(101,"MQIA_CHINIT_ADAPTERS"),(102,"MQIA_ADOPTNEWMCA_CHECK"),(103,"MQIA_ADOPTNEWMCA_TYPE"),(104,"MQIA_ADOPTNEWMCA_INTERVAL"),(105,"MQIA_CHINIT_DISPATCHERS"),(106,"MQIA_DNS_WLM"),(107,"MQIA_LISTENER_TIMER"),(108,"MQIA_LU62_CHANNELS"),(109,"MQIA_MAX_CHANNELS"),(110,"MQIA_OUTBOUND_PORT_MIN"),(111,"MQIA_RECEIVE_TIMEOUT"),(112,"MQIA_RECEIVE_TIMEOUT_TYPE"),(113,"MQIA_RECEIVE_TIMEOUT_MIN"),(114,"MQIA_TCP_CHANNELS"),(115,"MQIA_TCP_KEEP_ALIVE"),(116,"MQIA_TCP_STACK_TYPE"),(117,"MQIA_CHINIT_TRACE_AUTO_START"),(118,"MQIA_CHINIT_TRACE_TABLE_SIZE"),(119,"MQIA_CHINIT_CONTROL"),(120,"MQIA_CMD_SERVER_CONTROL"),(121,"MQIA_SERVICE_TYPE"),(122,"MQIA_MONITORING_CHANNEL"),(123,"MQIA_MONITORING_Q"),(124,"MQIA_MONITORING_AUTO_CLUSSDR"),(127,"MQIA_STATISTICS_MQI"),(128,"MQIA_STATISTICS_Q"),(129,"MQIA_STATISTICS_CHANNEL"),(130,"MQIA_STATISTICS_AUTO_CLUSSDR"),(131,"MQIA_STATISTICS_INTERVAL"),(133,"MQIA_ACCOUNTING_MQI"),(134,"MQIA_ACCOUNTING_Q"),(135,"MQIA_ACCOUNTING_INTERVAL"),(136,"MQIA_ACCOUNTING_CONN_OVERRIDE"),(137,"MQIA_TRACE_ROUTE_RECORDING"),(138,"MQIA_ACTIVITY_RECORDING"),(139,"MQIA_SERVICE_CONTROL"),(140,"MQIA_OUTBOUND_PORT_MAX"),(141,"MQIA_SECURITY_CASE"),(150,"MQIA_QMOPT_CSMT_ON_ERROR"),(151,"MQIA_QMOPT_CONS_INFO_MSGS"),(152,"MQIA_QMOPT_CONS_WARNING_MSGS"),(153,"MQIA_QMOPT_CONS_ERROR_MSGS"),(154,"MQIA_QMOPT_CONS_CRITICAL_MSGS"),(155,"MQIA_QMOPT_CONS_COMMS_MSGS"),(156,"MQIA_QMOPT_CONS_REORG_MSGS"),(157,"MQIA_QMOPT_CONS_SYSTEM_MSGS"),(158,"MQIA_QMOPT_LOG_INFO_MSGS"),(159,"MQIA_QMOPT_LOG_WARNING_MSGS"),(160,"MQIA_QMOPT_LOG_ERROR_MSGS"),(161,"MQIA_QMOPT_LOG_CRITICAL_MSGS"),(162,"MQIA_QMOPT_LOG_COMMS_MSGS"),(163,"MQIA_QMOPT_LOG_REORG_MSGS"),(164,"MQIA_QMOPT_LOG_SYSTEM_MSGS"),(165,"MQIA_QMOPT_TRACE_MQI_CALLS"),(166,"MQIA_QMOPT_TRACE_COMMS"),(167,"MQIA_QMOPT_TRACE_REORG"),(168,"MQIA_QMOPT_TRACE_CONVERSION"),(169,"MQIA_QMOPT_TRACE_SYSTEM"),(170,"MQIA_QMOPT_INTERNAL_DUMP"),(171,"MQIA_MAX_RECOVERY_TASKS"),(172,"MQIA_MAX_CLIENTS"),(173,"MQIA_AUTO_REORGANIZATION"),(174,"MQIA_AUTO_REORG_INTERVAL"),(175,"MQIA_DURABLE_SUB"),(176,"MQIA_MULTICAST"),(181,"MQIA_INHIBIT_PUB"),(182,"MQIA_INHIBIT_SUB"),(183,"MQIA_TREE_LIFE_TIME"),(184,"MQIA_DEF_PUT_RESPONSE_TYPE"),(185,"MQIA_TOPIC_DEF_PERSISTENCE"),(186,"MQIA_MASTER_ADMIN"),(187,"MQIA_PUBSUB_MODE"),(188,"MQIA_DEF_READ_AHEAD"),(189,"MQIA_READ_AHEAD"),(190,"MQIA_PROPERTY_CONTROL"),(192,"MQIA_MAX_PROPERTIES_LENGTH"),(193,"MQIA_BASE_TYPE"),(195,"MQIA_PM_DELIVERY"),(196,"MQIA_NPM_DELIVERY"),(199,"MQIA_PROXY_SUB"),(203,"MQIA_PUBSUB_NP_MSG"),(204,"MQIA_SUB_COUNT"),(205,"MQIA_PUBSUB_NP_RESP"),(206,"MQIA_PUBSUB_MAXMSG_RETRY_COUNT"),(207,"MQIA_PUBSUB_SYNC_PT"),(208,"MQIA_TOPIC_TYPE"),(215,"MQIA_PUB_COUNT"),(216,"MQIA_WILDCARD_OPERATION"),(218,"MQIA_SUB_SCOPE"),(219,"MQIA_PUB_SCOPE"),(221,"MQIA_GROUP_UR"),(222,"MQIA_UR_DISP"),(223,"MQIA_COMM_INFO_TYPE"),(224,"MQIA_CF_OFFLOAD"),(225,"MQIA_CF_OFFLOAD_THRESHOLD1"),(226,"MQIA_CF_OFFLOAD_THRESHOLD2"),(227,"MQIA_CF_OFFLOAD_THRESHOLD3"),(228,"MQIA_CF_SMDS_BUFFERS"),(229,"MQIA_CF_OFFLDUSE"),(230,"MQIA_MAX_RESPONSES"),(231,"MQIA_RESPONSE_RESTART_POINT"),(232,"MQIA_COMM_EVENT"),(233,"MQIA_MCAST_BRIDGE"),(234,"MQIA_USE_DEAD_LETTER_Q"),(235,"MQIA_TOLERATE_UNPROTECTED"),(236,"MQIA_SIGNATURE_ALGORITHM"),(237,"MQIA_ENCRYPTION_ALGORITHM"),(238,"MQIA_POLICY_VERSION"),(239,"MQIA_ACTIVITY_CONN_OVERRIDE"),(240,"MQIA_ACTIVITY_TRACE"),(242,"MQIA_SUB_CONFIGURATION_EVENT"),(243,"MQIA_XR_CAPABILITY"),(244,"MQIA_CF_RECAUTO"),(245,"MQIA_QMGR_CFCONLOS"),(246,"MQIA_CF_CFCONLOS"),(247,"MQIA_SUITE_B_STRENGTH"),(248,"MQIA_CHLAUTH_RECORDS"),(249,"MQIA_PUBSUB_CLUSTER"),(250,"MQIA_DEF_CLUSTER_XMIT_Q_TYPE"),(251,"MQIA_PROT_POLICY_CAPABILITY"),(252,"MQIA_CERT_VAL_POLICY"),(253,"MQIA_TOPIC_NODE_COUNT"),(254,"MQIA_REVERSE_DNS_LOOKUP"),(255,"MQIA_CLUSTER_PUB_ROUTE"),(256,"MQIA_CLUSTER_OBJECT_STATE"),(257,"MQIA_CHECK_LOCAL_BINDING"),(258,"MQIA_CHECK_CLIENT_BINDING"),(259,"MQIA_AUTHENTICATION_FAIL_DELAY"),(260,"MQIA_ADOPT_CONTEXT"),(261,"MQIA_LDAP_SECURE_COMM"),(262,"MQIA_DISPLAY_TYPE"),(263,"MQIA_LDAP_AUTHORMD"),(264,"MQIA_LDAP_NESTGRP"),(265,"MQIA_AMQP_CAPABILITY"),(266,"MQIA_AUTHENTICATION_METHOD"),(267,"MQIA_KEY_REUSE_COUNT"),(268,"MQIA_MEDIA_IMAGE_SCHEDULING"),(269,"MQIA_MEDIA_IMAGE_INTERVAL"),(270,"MQIA_MEDIA_IMAGE_LOG_LENGTH"),(271,"MQIA_MEDIA_IMAGE_RECOVER_OBJ"),(272,"MQIA_MEDIA_IMAGE_RECOVER_Q"),(273,"MQIA_ADVANCED_CAPABILITY"),(274,"MQIA_MAX_Q_FILE_SIZE"),(275,"MQIA_STREAM_QUEUE_QOS"),(276,"MQIA_CAP_EXPIRY"),(2000,"MQIA_USER_LIST"),]), &[]);
pub const MQIDO_CONST: LinearSource = ConstSource(&[(1,"MQIDO_COMMIT"),(2,"MQIDO_BACKOUT"),], &[]);
pub const MQIEPF_CONST: LinearSource = ConstSource(&[(0,"MQIEPF_NONE"),(1,"MQIEPF_THREADED_LIBRARY"),(2,"MQIEPF_LOCAL_LIBRARY"),], &[(0,"MQIEPF_CLIENT_LIBRARY"),(0,"MQIEPF_NON_THREADED_LIBRARY"),]);
pub const MQIGQPA_CONST: LinearSource = ConstSource(&[(1,"MQIGQPA_DEFAULT"),(2,"MQIGQPA_CONTEXT"),(3,"MQIGQPA_ONLY_IGQ"),(4,"MQIGQPA_ALTERNATE_OR_IGQ"),], &[]);
pub const MQIGQ_CONST: LinearSource = ConstSource(&[(0,"MQIGQ_DISABLED"),(1,"MQIGQ_ENABLED"),], &[]);
pub const MQIIH_CONST: LinearSource = ConstSource(&[(0,"MQIIH_NONE"),(1,"MQIIH_PASS_EXPIRATION"),(8,"MQIIH_REPLY_FORMAT_NONE"),(16,"MQIIH_IGNORE_PURG"),(32,"MQIIH_CM0_REQUEST_RESPONSE"),], &[(0,"MQIIH_UNLIMITED_EXPIRATION"),]);
pub const MQIMGRCOV_CONST: LinearSource = ConstSource(&[(0,"MQIMGRCOV_NO"),(1,"MQIMGRCOV_YES"),(2,"MQIMGRCOV_AS_Q_MGR"),], &[]);
pub const MQIMMREASON_CONST: LinearSource = ConstSource(&[(0,"MQIMMREASON_NONE"),(1,"MQIMMREASON_NOT_CLIENT"),(2,"MQIMMREASON_NOT_RECONNECTABLE"),(3,"MQIMMREASON_MOVING"),(4,"MQIMMREASON_APPLNAME_CHANGED"),(5,"MQIMMREASON_IN_TRANSACTION"),(6,"MQIMMREASON_AWAITS_REPLY"),(7,"MQIMMREASON_NO_REDIRECT"),], &[]);
pub const MQIMPO_CONST: LinearSource = ConstSource(&[(0,"MQIMPO_NONE"),(2,"MQIMPO_CONVERT_TYPE"),(4,"MQIMPO_QUERY_LENGTH"),(8,"MQIMPO_INQ_NEXT"),(16,"MQIMPO_INQ_PROP_UNDER_CURSOR"),(32,"MQIMPO_CONVERT_VALUE"),], &[]);
pub const MQINBD_CONST: LinearSource = ConstSource(&[(0,"MQINBD_Q_MGR"),(3,"MQINBD_GROUP"),], &[]);
pub const MQIND_CONST: LinearSource = ConstSource(&[(-2,"MQIND_ALL"),(-1,"MQIND_NONE"),], &[]);
pub const MQIPADDR_CONST: LinearSource = ConstSource(&[(0,"MQIPADDR_IPV4"),(1,"MQIPADDR_IPV6"),], &[]);
pub const MQIS_CONST: LinearSource = ConstSource(&[(0,"MQIS_NO"),(1,"MQIS_YES"),], &[]);
pub const MQITEM_CONST: LinearSource = ConstSource(&[(1,"MQITEM_INTEGER"),(2,"MQITEM_STRING"),(3,"MQITEM_BAG"),(4,"MQITEM_BYTE_STRING"),(5,"MQITEM_INTEGER_FILTER"),(6,"MQITEM_STRING_FILTER"),(7,"MQITEM_INTEGER64"),(8,"MQITEM_BYTE_STRING_FILTER"),], &[]);
pub const MQIT_CONST: LinearSource = ConstSource(&[(0,"MQIT_NONE"),(1,"MQIT_MSG_ID"),(2,"MQIT_CORREL_ID"),(4,"MQIT_MSG_TOKEN"),(5,"MQIT_GROUP_ID"),], &[(1,"MQIT_INTEGER"),(2,"MQIT_STRING"),(3,"MQIT_BAG"),]);
pub const MQKAI_CONST: LinearSource = ConstSource(&[(-1,"MQKAI_AUTO"),], &[]);
pub const MQKEY_CONST: LinearSource = ConstSource(&[(-1,"MQKEY_REUSE_UNLIMITED"),(0,"MQKEY_REUSE_DISABLED"),], &[]);
pub const MQLDAPC_CONST: LinearSource = ConstSource(&[(0,"MQLDAPC_INACTIVE"),(1,"MQLDAPC_CONNECTED"),(2,"MQLDAPC_ERROR"),], &[]);
pub const MQLDAP_AUTHORMD_CONST: LinearSource = ConstSource(&[(0,"MQLDAP_AUTHORMD_OS"),(1,"MQLDAP_AUTHORMD_SEARCHGRP"),(2,"MQLDAP_AUTHORMD_SEARCHUSR"),(3,"MQLDAP_AUTHORMD_SRCHGRPSN"),], &[]);
pub const MQLDAP_NESTGRP_CONST: LinearSource = ConstSource(&[(0,"MQLDAP_NESTGRP_NO"),(1,"MQLDAP_NESTGRP_YES"),], &[]);
pub const MQLOGTYPE_CONST: LinearSource = ConstSource(&[(0,"MQLOGTYPE_CIRCULAR"),(1,"MQLOGTYPE_LINEAR"),(2,"MQLOGTYPE_REPLICATED"),], &[]);
pub const MQLR_CONST: LinearSource = ConstSource(&[(-2,"MQLR_MAX"),(-1,"MQLR_AUTO"),(1,"MQLR_ONE"),], &[]);
pub const MQMASTER_CONST: LinearSource = ConstSource(&[(0,"MQMASTER_NO"),(1,"MQMASTER_YES"),], &[]);
pub const MQMATCH_CONST: LinearSource = ConstSource(&[(0,"MQMATCH_GENERIC"),(1,"MQMATCH_RUNCHECK"),(2,"MQMATCH_EXACT"),(3,"MQMATCH_ALL"),], &[]);
pub const MQMCAS_CONST: LinearSource = ConstSource(&[(0,"MQMCAS_STOPPED"),(3,"MQMCAS_RUNNING"),], &[]);
pub const MQMCAT_CONST: LinearSource = ConstSource(&[(1,"MQMCAT_PROCESS"),(2,"MQMCAT_THREAD"),], &[]);
pub const MQMCB_CONST: LinearSource = ConstSource(&[(0,"MQMCB_DISABLED"),(1,"MQMCB_ENABLED"),], &[]);
pub const MQMCEV_CONST: LinearSource = ConstSource(&[(1,"MQMCEV_PACKET_LOSS"),(2,"MQMCEV_HEARTBEAT_TIMEOUT"),(3,"MQMCEV_VERSION_CONFLICT"),(4,"MQMCEV_RELIABILITY"),(5,"MQMCEV_CLOSED_TRANS"),(6,"MQMCEV_STREAM_ERROR"),(10,"MQMCEV_NEW_SOURCE"),(11,"MQMCEV_RECEIVE_QUEUE_TRIMMED"),(12,"MQMCEV_PACKET_LOSS_NACK_EXPIRE"),(13,"MQMCEV_ACK_RETRIES_EXCEEDED"),(14,"MQMCEV_STREAM_SUSPEND_NACK"),(15,"MQMCEV_STREAM_RESUME_NACK"),(16,"MQMCEV_STREAM_EXPELLED"),(20,"MQMCEV_FIRST_MESSAGE"),(21,"MQMCEV_LATE_JOIN_FAILURE"),(22,"MQMCEV_MESSAGE_LOSS"),(23,"MQMCEV_SEND_PACKET_FAILURE"),(24,"MQMCEV_REPAIR_DELAY"),(25,"MQMCEV_MEMORY_ALERT_ON"),(26,"MQMCEV_MEMORY_ALERT_OFF"),(27,"MQMCEV_NACK_ALERT_ON"),(28,"MQMCEV_NACK_ALERT_OFF"),(29,"MQMCEV_REPAIR_ALERT_ON"),(30,"MQMCEV_REPAIR_ALERT_OFF"),(31,"MQMCEV_RELIABILITY_CHANGED"),(80,"MQMCEV_SHM_DEST_UNUSABLE"),(81,"MQMCEV_SHM_PORT_UNUSABLE"),(110,"MQMCEV_CCT_GETTIME_FAILED"),(120,"MQMCEV_DEST_INTERFACE_FAILURE"),(121,"MQMCEV_DEST_INTERFACE_FAILOVER"),(122,"MQMCEV_PORT_INTERFACE_FAILURE"),(123,"MQMCEV_PORT_INTERFACE_FAILOVER"),], &[]);
pub const MQMCP_CONST: LinearSource = ConstSource(&[(-2,"MQMCP_COMPAT"),(-1,"MQMCP_ALL"),(0,"MQMCP_NONE"),(1,"MQMCP_USER"),(2,"MQMCP_REPLY"),], &[]);
pub const MQMC_CONST: LinearSource = ConstSource(&[(0,"MQMC_AS_PARENT"),(1,"MQMC_ENABLED"),(2,"MQMC_DISABLED"),(3,"MQMC_ONLY"),], &[]);
pub const MQMDEF_CONST: LinearSource = ConstSource(&[(0,"MQMDEF_NONE"),], &[]);
pub const MQMDS_CONST: LinearSource = ConstSource(&[(0,"MQMDS_PRIORITY"),(1,"MQMDS_FIFO"),], &[]);
pub const MQMEDIMGINTVL_CONST: LinearSource = ConstSource(&[(0,"MQMEDIMGINTVL_OFF"),], &[]);
pub const MQMEDIMGLOGLN_CONST: LinearSource = ConstSource(&[(0,"MQMEDIMGLOGLN_OFF"),], &[]);
pub const MQMEDIMGSCHED_CONST: LinearSource = ConstSource(&[(0,"MQMEDIMGSCHED_MANUAL"),(1,"MQMEDIMGSCHED_AUTO"),], &[]);
pub const MQMF_CONST: LinearSource = ConstSource(&[(-1048576,"MQMF_ACCEPT_UNSUP_MASK"),(0,"MQMF_NONE"),(1,"MQMF_SEGMENTATION_ALLOWED"),(2,"MQMF_SEGMENT"),(4,"MQMF_LAST_SEGMENT"),(8,"MQMF_MSG_IN_GROUP"),(16,"MQMF_LAST_MSG_IN_GROUP"),(4095,"MQMF_REJECT_UNSUP_MASK"),(1044480,"MQMF_ACCEPT_UNSUP_IF_XMIT_MASK"),], &[(0,"MQMF_SEGMENTATION_INHIBITED"),]);
pub const MQMHBO_CONST: LinearSource = ConstSource(&[(0,"MQMHBO_NONE"),(1,"MQMHBO_PROPERTIES_IN_MQRFH2"),(2,"MQMHBO_DELETE_PROPERTIES"),], &[]);
pub const MQMLP_ENCRYPTION_CONST: LinearSource = ConstSource(&[(0,"MQMLP_ENCRYPTION_ALG_NONE"),(1,"MQMLP_ENCRYPTION_ALG_RC2"),(2,"MQMLP_ENCRYPTION_ALG_DES"),(3,"MQMLP_ENCRYPTION_ALG_3DES"),(4,"MQMLP_ENCRYPTION_ALG_AES128"),(5,"MQMLP_ENCRYPTION_ALG_AES256"),], &[]);
pub const MQMLP_SIGN_CONST: LinearSource = ConstSource(&[(0,"MQMLP_SIGN_ALG_NONE"),(1,"MQMLP_SIGN_ALG_MD5"),(2,"MQMLP_SIGN_ALG_SHA1"),(3,"MQMLP_SIGN_ALG_SHA224"),(4,"MQMLP_SIGN_ALG_SHA256"),(5,"MQMLP_SIGN_ALG_SHA384"),(6,"MQMLP_SIGN_ALG_SHA512"),], &[]);
pub const MQMLP_TOLERATE_CONST: LinearSource = ConstSource(&[(0,"MQMLP_TOLERATE_UNPROTECTED_NO"),(1,"MQMLP_TOLERATE_UNPROTECTED_YES"),], &[]);
pub const MQMMBI_CONST: LinearSource = ConstSource(&[(-1,"MQMMBI_UNLIMITED"),], &[]);
pub const MQMODE_CONST: LinearSource = ConstSource(&[(0,"MQMODE_FORCE"),(1,"MQMODE_QUIESCE"),(2,"MQMODE_TERMINATE"),], &[]);
pub const MQMON_CONST: LinearSource = ConstSource(&[(-3,"MQMON_Q_MGR"),(-1,"MQMON_NONE"),(0,"MQMON_OFF"),(1,"MQMON_ON"),(17,"MQMON_LOW"),(33,"MQMON_MEDIUM"),(65,"MQMON_HIGH"),], &[]);
pub const MQMON_AVAILABILITY_CONST: LinearSource = ConstSource(&[(-1,"MQMON_NOT_AVAILABLE"),], &[]);
pub const MQMON_OVERRIDE_CONST: LinearSource = ConstSource(&[(0,"MQMON_DISABLED"),(1,"MQMON_ENABLED"),], &[]);
pub const MQMO_CONST: LinearSource = ConstSource(&[(0,"MQMO_NONE"),(1,"MQMO_MATCH_MSG_ID"),(2,"MQMO_MATCH_CORREL_ID"),(4,"MQMO_MATCH_GROUP_ID"),(8,"MQMO_MATCH_MSG_SEQ_NUMBER"),(16,"MQMO_MATCH_OFFSET"),(32,"MQMO_MATCH_MSG_TOKEN"),], &[]);
pub const MQMT_CONST: LinearSource = ConstSource(&[(1,"MQMT_REQUEST"),(2,"MQMT_REPLY"),(4,"MQMT_REPORT"),(8,"MQMT_DATAGRAM"),(112,"MQMT_MQE_FIELDS_FROM_MQE"),(113,"MQMT_MQE_FIELDS"),], &[]);
pub const MQMULC_CONST: LinearSource = ConstSource(&[(0,"MQMULC_STANDARD"),(1,"MQMULC_REFINED"),], &[]);
pub const MQNC_CONST: LinearSource = ConstSource(&[(256,"MQNC_MAX_NAMELIST_NAME_COUNT"),], &[]);
pub const MQNHABACKLOG_CONST: LinearSource = ConstSource(&[(-1,"MQNHABACKLOG_UNKNOWN"),], &[]);
pub const MQNHACONNACTV_CONST: LinearSource = ConstSource(&[(0,"MQNHACONNACTV_NO"),(1,"MQNHACONNACTV_YES"),], &[]);
pub const MQNHAINSYNC_CONST: LinearSource = ConstSource(&[(0,"MQNHAINSYNC_NO"),(1,"MQNHAINSYNC_YES"),], &[]);
pub const MQNHAROLE_CONST: LinearSource = ConstSource(&[(0,"MQNHAROLE_UNKNOWN"),(1,"MQNHAROLE_ACTIVE"),(2,"MQNHAROLE_REPLICA"),], &[]);
pub const MQNPMS_CONST: LinearSource = ConstSource(&[(1,"MQNPMS_NORMAL"),(2,"MQNPMS_FAST"),], &[]);
pub const MQNPM_CONST: LinearSource = ConstSource(&[(0,"MQNPM_CLASS_NORMAL"),(10,"MQNPM_CLASS_HIGH"),], &[]);
pub const MQNSH_CONST: LinearSource = ConstSource(&[(-1,"MQNSH_ALL"),(0,"MQNSH_NONE"),], &[]);
pub const MQNT_CONST: LinearSource = ConstSource(&[(0,"MQNT_NONE"),(1,"MQNT_Q"),(2,"MQNT_CLUSTER"),(4,"MQNT_AUTH_INFO"),(1001,"MQNT_ALL"),], &[]);
pub const MQOL_CONST: LinearSource = ConstSource(&[(-1,"MQOL_UNDEFINED"),], &[]);
pub const MQOM_CONST: LinearSource = ConstSource(&[(0,"MQOM_NO"),(1,"MQOM_YES"),], &[]);
pub const MQOO_CONST: LinearSource = ConstSource(&[(0,"MQOO_READ_AHEAD_AS_Q_DEF"),(1,"MQOO_INPUT_AS_Q_DEF"),(2,"MQOO_INPUT_SHARED"),(4,"MQOO_INPUT_EXCLUSIVE"),(8,"MQOO_BROWSE"),(16,"MQOO_OUTPUT"),(32,"MQOO_INQUIRE"),(64,"MQOO_SET"),(128,"MQOO_SAVE_ALL_CONTEXT"),(256,"MQOO_PASS_IDENTITY_CONTEXT"),(512,"MQOO_PASS_ALL_CONTEXT"),(1024,"MQOO_SET_IDENTITY_CONTEXT"),(2048,"MQOO_SET_ALL_CONTEXT"),(4096,"MQOO_ALTERNATE_USER_AUTHORITY"),(8192,"MQOO_FAIL_IF_QUIESCING"),(16384,"MQOO_BIND_ON_OPEN"),(32768,"MQOO_BIND_NOT_FIXED"),(65536,"MQOO_RESOLVE_NAMES"),(131072,"MQOO_CO_OP"),(262144,"MQOO_RESOLVE_LOCAL_Q"),(524288,"MQOO_NO_READ_AHEAD"),(1048576,"MQOO_READ_AHEAD"),(2097152,"MQOO_NO_MULTICAST"),(4194304,"MQOO_BIND_ON_GROUP"),], &[(0,"MQOO_BIND_AS_Q_DEF"),(262144,"MQOO_RESOLVE_LOCAL_TOPIC"),]);
pub const MQOPER_CONST: LinearSource = ConstSource(&[(0,"MQOPER_UNKNOWN"),(1,"MQOPER_BROWSE"),(2,"MQOPER_DISCARD"),(3,"MQOPER_GET"),(4,"MQOPER_PUT"),(5,"MQOPER_PUT_REPLY"),(6,"MQOPER_PUT_REPORT"),(7,"MQOPER_RECEIVE"),(8,"MQOPER_SEND"),(9,"MQOPER_TRANSFORM"),(10,"MQOPER_PUBLISH"),(11,"MQOPER_EXCLUDED_PUBLISH"),(12,"MQOPER_DISCARDED_PUBLISH"),], &[]);
pub const MQOPMODE_CONST: LinearSource = ConstSource(&[(0,"MQOPMODE_COMPAT"),(1,"MQOPMODE_NEW_FUNCTION"),], &[]);
pub const MQOP_CONST: LinearSource = ConstSource(&[(1,"MQOP_START"),(2,"MQOP_START_WAIT"),(4,"MQOP_STOP"),(256,"MQOP_REGISTER"),(512,"MQOP_DEREGISTER"),(65536,"MQOP_SUSPEND"),(131072,"MQOP_RESUME"),], &[]);
pub const MQOT_CONST: LinearSource = ConstSource(&[(0,"MQOT_NONE"),(1,"MQOT_Q"),(2,"MQOT_NAMELIST"),(3,"MQOT_PROCESS"),(4,"MQOT_STORAGE_CLASS"),(5,"MQOT_Q_MGR"),(6,"MQOT_CHANNEL"),(7,"MQOT_AUTH_INFO"),(8,"MQOT_TOPIC"),(9,"MQOT_COMM_INFO"),(10,"MQOT_CF_STRUC"),(11,"MQOT_LISTENER"),(12,"MQOT_SERVICE"),(999,"MQOT_RESERVED_1"),(1001,"MQOT_ALL"),(1002,"MQOT_ALIAS_Q"),(1003,"MQOT_MODEL_Q"),(1004,"MQOT_LOCAL_Q"),(1005,"MQOT_REMOTE_Q"),(1007,"MQOT_SENDER_CHANNEL"),(1008,"MQOT_SERVER_CHANNEL"),(1009,"MQOT_REQUESTER_CHANNEL"),(1010,"MQOT_RECEIVER_CHANNEL"),(1011,"MQOT_CURRENT_CHANNEL"),(1012,"MQOT_SAVED_CHANNEL"),(1013,"MQOT_SVRCONN_CHANNEL"),(1014,"MQOT_CLNTCONN_CHANNEL"),(1015,"MQOT_SHORT_CHANNEL"),(1016,"MQOT_CHLAUTH"),(1017,"MQOT_REMOTE_Q_MGR_NAME"),(1019,"MQOT_PROT_POLICY"),(1020,"MQOT_TT_CHANNEL"),(1021,"MQOT_AMQP_CHANNEL"),(1022,"MQOT_AUTH_REC"),], &[]);
pub const MQPAGECLAS_CONST: LinearSource = ConstSource(&[(0,"MQPAGECLAS_4KB"),(1,"MQPAGECLAS_FIXED4KB"),], &[]);
pub const MQPA_CONST: LinearSource = ConstSource(&[(1,"MQPA_DEFAULT"),(2,"MQPA_CONTEXT"),(3,"MQPA_ONLY_MCA"),(4,"MQPA_ALTERNATE_OR_MCA"),], &[]);
pub const MQPD_CONST: LinearSource = ConstSource(&[(-1048576,"MQPD_REJECT_UNSUP_MASK"),(0,"MQPD_NONE"),(1,"MQPD_SUPPORT_OPTIONAL"),(1023,"MQPD_ACCEPT_UNSUP_MASK"),(1024,"MQPD_SUPPORT_REQUIRED_IF_LOCAL"),(1047552,"MQPD_ACCEPT_UNSUP_IF_XMIT_MASK"),(1048576,"MQPD_SUPPORT_REQUIRED"),], &[(0,"MQPD_NO_CONTEXT"),(1,"MQPD_USER_CONTEXT"),]);
pub const MQPER_CONST: LinearSource = ConstSource(&[(-1,"MQPER_PERSISTENCE_AS_PARENT"),(0,"MQPER_NOT_PERSISTENT"),(1,"MQPER_PERSISTENT"),(2,"MQPER_PERSISTENCE_AS_Q_DEF"),], &[(2,"MQPER_PERSISTENCE_AS_TOPIC_DEF"),]);
pub const MQPL_CONST: LinearSource = ConstSource(&[(1,"MQPL_ZOS"),(2,"MQPL_OS2"),(3,"MQPL_UNIX"),(4,"MQPL_OS400"),(5,"MQPL_WINDOWS"),(11,"MQPL_WINDOWS_NT"),(12,"MQPL_VMS"),(13,"MQPL_NSK"),(15,"MQPL_OPEN_TP1"),(18,"MQPL_VM"),(23,"MQPL_TPF"),(27,"MQPL_VSE"),(28,"MQPL_APPLIANCE"),], &[(1,"MQPL_MVS"),(1,"MQPL_OS390"),(3,"MQPL_AIX"),(13,"MQPL_NSS"),]);
pub const MQPMO_CONST: LinearSource = ConstSource(&[(0,"MQPMO_NONE"),(2,"MQPMO_SYNCPOINT"),(4,"MQPMO_NO_SYNCPOINT"),(32,"MQPMO_DEFAULT_CONTEXT"),(64,"MQPMO_NEW_MSG_ID"),(128,"MQPMO_NEW_CORREL_ID"),(256,"MQPMO_PASS_IDENTITY_CONTEXT"),(512,"MQPMO_PASS_ALL_CONTEXT"),(1024,"MQPMO_SET_IDENTITY_CONTEXT"),(2048,"MQPMO_SET_ALL_CONTEXT"),(4096,"MQPMO_ALTERNATE_USER_AUTHORITY"),(8192,"MQPMO_FAIL_IF_QUIESCING"),(16384,"MQPMO_NO_CONTEXT"),(32768,"MQPMO_LOGICAL_ORDER"),(65536,"MQPMO_ASYNC_RESPONSE"),(131072,"MQPMO_SYNC_RESPONSE"),(262144,"MQPMO_RESOLVE_LOCAL_Q"),(524288,"MQPMO_WARN_IF_NO_SUBS_MATCHED"),(2097152,"MQPMO_RETAIN"),(8388608,"MQPMO_MD_FOR_OUTPUT_ONLY"),(67108864,"MQPMO_SCOPE_QMGR"),(134217728,"MQPMO_SUPPRESS_REPLYTO"),(268435456,"MQPMO_NOT_OWN_SUBS"),], &[(0,"MQPMO_RESPONSE_AS_Q_DEF"),(0,"MQPMO_RESPONSE_AS_TOPIC_DEF"),(2097152,"MQPMO_PUB_OPTIONS_MASK"),]);
pub const MQPMRF_CONST: LinearSource = ConstSource(&[(0,"MQPMRF_NONE"),(1,"MQPMRF_MSG_ID"),(2,"MQPMRF_CORREL_ID"),(4,"MQPMRF_GROUP_ID"),(8,"MQPMRF_FEEDBACK"),(16,"MQPMRF_ACCOUNTING_TOKEN"),], &[]);
pub const MQPO_CONST: LinearSource = ConstSource(&[(0,"MQPO_NO"),(1,"MQPO_YES"),], &[]);
pub const MQPRI_CONST: LinearSource = ConstSource(&[(-3,"MQPRI_PRIORITY_AS_PUBLISHED"),(-2,"MQPRI_PRIORITY_AS_PARENT"),(-1,"MQPRI_PRIORITY_AS_Q_DEF"),], &[(-1,"MQPRI_PRIORITY_AS_TOPIC_DEF"),]);
pub const MQPROP_CONST: LinearSource = ConstSource(&[(-1,"MQPROP_UNRESTRICTED_LENGTH"),(0,"MQPROP_COMPATIBILITY"),(1,"MQPROP_NONE"),(2,"MQPROP_ALL"),(3,"MQPROP_FORCE_MQRFH2"),(4,"MQPROP_V6COMPAT"),], &[]);
pub const MQPROTO_CONST: LinearSource = ConstSource(&[(1,"MQPROTO_MQTTV3"),(2,"MQPROTO_HTTP"),(3,"MQPROTO_AMQP"),(4,"MQPROTO_MQTTV311"),], &[]);
pub const MQPRT_CONST: LinearSource = ConstSource(&[(0,"MQPRT_RESPONSE_AS_PARENT"),(1,"MQPRT_SYNC_RESPONSE"),(2,"MQPRT_ASYNC_RESPONSE"),], &[]);
pub const MQPSCLUS_CONST: LinearSource = ConstSource(&[(0,"MQPSCLUS_DISABLED"),(1,"MQPSCLUS_ENABLED"),], &[]);
pub const MQPSCT_CONST: LinearSource = ConstSource(&[(-1,"MQPSCT_NONE"),], &[]);
pub const MQPSM_CONST: LinearSource = ConstSource(&[(0,"MQPSM_DISABLED"),(1,"MQPSM_COMPAT"),(2,"MQPSM_ENABLED"),], &[]);
pub const MQPSPROP_CONST: LinearSource = ConstSource(&[(0,"MQPSPROP_NONE"),(1,"MQPSPROP_COMPAT"),(2,"MQPSPROP_RFH2"),(3,"MQPSPROP_MSGPROP"),], &[]);
pub const MQPSST_CONST: LinearSource = ConstSource(&[(0,"MQPSST_ALL"),(1,"MQPSST_LOCAL"),(2,"MQPSST_PARENT"),(3,"MQPSST_CHILD"),], &[]);
pub const MQPS_CONST: LinearSource = ConstSource(&[(0,"MQPS_STATUS_INACTIVE"),(1,"MQPS_STATUS_STARTING"),(2,"MQPS_STATUS_STOPPING"),(3,"MQPS_STATUS_ACTIVE"),(4,"MQPS_STATUS_COMPAT"),(5,"MQPS_STATUS_ERROR"),(6,"MQPS_STATUS_REFUSED"),], &[]);
pub const MQPUBO_CONST: LinearSource = ConstSource(&[(0,"MQPUBO_NONE"),(1,"MQPUBO_CORREL_ID_AS_IDENTITY"),(2,"MQPUBO_RETAIN_PUBLICATION"),(4,"MQPUBO_OTHER_SUBSCRIBERS_ONLY"),(8,"MQPUBO_NO_REGISTRATION"),(16,"MQPUBO_IS_RETAINED_PUBLICATION"),], &[]);
pub const MQQA_BACKOUT_CONST: LinearSource = ConstSource(&[(0,"MQQA_BACKOUT_NOT_HARDENED"),(1,"MQQA_BACKOUT_HARDENED"),], &[]);
pub const MQQA_GET_CONST: LinearSource = ConstSource(&[(0,"MQQA_GET_ALLOWED"),(1,"MQQA_GET_INHIBITED"),], &[]);
pub const MQQA_PUT_CONST: LinearSource = ConstSource(&[(0,"MQQA_PUT_ALLOWED"),(1,"MQQA_PUT_INHIBITED"),], &[]);
pub const MQQA_SHAREABLE_CONST: LinearSource = ConstSource(&[(0,"MQQA_NOT_SHAREABLE"),(1,"MQQA_SHAREABLE"),], &[]);
pub const MQQDT_CONST: LinearSource = ConstSource(&[(1,"MQQDT_PREDEFINED"),(2,"MQQDT_PERMANENT_DYNAMIC"),(3,"MQQDT_TEMPORARY_DYNAMIC"),(4,"MQQDT_SHARED_DYNAMIC"),], &[]);
pub const MQQFS_CONST: LinearSource = ConstSource(&[(-1,"MQQFS_DEFAULT"),], &[]);
pub const MQQF_CONST: LinearSource = ConstSource(&[(1,"MQQF_LOCAL_Q"),(64,"MQQF_CLWL_USEQ_ANY"),(128,"MQQF_CLWL_USEQ_LOCAL"),], &[]);
pub const MQQMDT_CONST: LinearSource = ConstSource(&[(1,"MQQMDT_EXPLICIT_CLUSTER_SENDER"),(2,"MQQMDT_AUTO_CLUSTER_SENDER"),(3,"MQQMDT_CLUSTER_RECEIVER"),(4,"MQQMDT_AUTO_EXP_CLUSTER_SENDER"),], &[]);
pub const MQQMFAC_CONST: LinearSource = ConstSource(&[(1,"MQQMFAC_IMS_BRIDGE"),(2,"MQQMFAC_DB2"),], &[]);
pub const MQQMF_CONST: LinearSource = ConstSource(&[(2,"MQQMF_REPOSITORY_Q_MGR"),(8,"MQQMF_CLUSSDR_USER_DEFINED"),(16,"MQQMF_CLUSSDR_AUTO_DEFINED"),(32,"MQQMF_AVAILABLE"),], &[]);
pub const MQQMOPT_CONST: LinearSource = ConstSource(&[(0,"MQQMOPT_DISABLED"),(1,"MQQMOPT_ENABLED"),(2,"MQQMOPT_REPLY"),], &[]);
pub const MQQMSTA_CONST: LinearSource = ConstSource(&[(1,"MQQMSTA_STARTING"),(2,"MQQMSTA_RUNNING"),(3,"MQQMSTA_QUIESCING"),(4,"MQQMSTA_STANDBY"),], &[]);
pub const MQQMT_CONST: LinearSource = ConstSource(&[(0,"MQQMT_NORMAL"),(1,"MQQMT_REPOSITORY"),], &[]);
pub const MQQO_CONST: LinearSource = ConstSource(&[(0,"MQQO_NO"),(1,"MQQO_YES"),], &[]);
pub const MQQSGD_CONST: LinearSource = ConstSource(&[(-1,"MQQSGD_ALL"),(0,"MQQSGD_Q_MGR"),(1,"MQQSGD_COPY"),(2,"MQQSGD_SHARED"),(3,"MQQSGD_GROUP"),(4,"MQQSGD_PRIVATE"),(6,"MQQSGD_LIVE"),], &[]);
pub const MQQSGS_CONST: LinearSource = ConstSource(&[(0,"MQQSGS_UNKNOWN"),(1,"MQQSGS_CREATED"),(2,"MQQSGS_ACTIVE"),(3,"MQQSGS_INACTIVE"),(4,"MQQSGS_FAILED"),(5,"MQQSGS_PENDING"),], &[]);
pub const MQQSIE_CONST: LinearSource = ConstSource(&[(0,"MQQSIE_NONE"),(1,"MQQSIE_HIGH"),(2,"MQQSIE_OK"),], &[]);
pub const MQQSOT_CONST: LinearSource = ConstSource(&[(1,"MQQSOT_ALL"),(2,"MQQSOT_INPUT"),(3,"MQQSOT_OUTPUT"),], &[]);
pub const MQQSO_CONST: LinearSource = ConstSource(&[(0,"MQQSO_NO"),(1,"MQQSO_YES"),(2,"MQQSO_EXCLUSIVE"),], &[(1,"MQQSO_SHARED"),]);
pub const MQQSUM_CONST: LinearSource = ConstSource(&[(0,"MQQSUM_NO"),(1,"MQQSUM_YES"),], &[]);
pub const MQQT_CONST: LinearSource = ConstSource(&[(1,"MQQT_LOCAL"),(2,"MQQT_MODEL"),(3,"MQQT_ALIAS"),(6,"MQQT_REMOTE"),(7,"MQQT_CLUSTER"),(1001,"MQQT_ALL"),], &[]);
pub const MQRAR_CONST: LinearSource = ConstSource(&[(0,"MQRAR_NO"),(1,"MQRAR_YES"),], &[]);
pub const MQRCCF_CONST: PhfSource = ConstSource(&::phf::Map {
    key: 12913932095322966823,
    disps: &[
        (0, 177),
        (0, 8),
...
pub const MQRCN_CONST: LinearSource = ConstSource(&[(0,"MQRCN_NO"),(1,"MQRCN_YES"),(2,"MQRCN_Q_MGR"),(3,"MQRCN_DISABLED"),], &[]);
pub const MQRCVTIME_CONST: LinearSource = ConstSource(&[(0,"MQRCVTIME_MULTIPLY"),(1,"MQRCVTIME_ADD"),(2,"MQRCVTIME_EQUAL"),], &[]);
pub const MQRC_CONST: PhfSource = ConstSource(&::phf::Map {
    key: 12913932095322966823,
    disps: &[
        (0, 233),
        (0, 5),
...
pub const MQRDNS_CONST: LinearSource = ConstSource(&[(0,"MQRDNS_ENABLED"),(1,"MQRDNS_DISABLED"),], &[]);
pub const MQRD_CONST: LinearSource = ConstSource(&[(-1,"MQRD_NO_RECONNECT"),(0,"MQRD_NO_DELAY"),], &[]);
pub const MQREADA_CONST: LinearSource = ConstSource(&[(0,"MQREADA_NO"),(1,"MQREADA_YES"),(2,"MQREADA_DISABLED"),(3,"MQREADA_INHIBITED"),(4,"MQREADA_BACKLOG"),], &[]);
pub const MQRECAUTO_CONST: LinearSource = ConstSource(&[(0,"MQRECAUTO_NO"),(1,"MQRECAUTO_YES"),], &[]);
pub const MQRECORDING_CONST: LinearSource = ConstSource(&[(0,"MQRECORDING_DISABLED"),(1,"MQRECORDING_Q"),(2,"MQRECORDING_MSG"),], &[]);
pub const MQREGO_CONST: LinearSource = ConstSource(&[(0,"MQREGO_NONE"),(1,"MQREGO_CORREL_ID_AS_IDENTITY"),(2,"MQREGO_ANONYMOUS"),(4,"MQREGO_LOCAL"),(8,"MQREGO_DIRECT_REQUESTS"),(16,"MQREGO_NEW_PUBLICATIONS_ONLY"),(32,"MQREGO_PUBLISH_ON_REQUEST_ONLY"),(64,"MQREGO_DEREGISTER_ALL"),(128,"MQREGO_INCLUDE_STREAM_NAME"),(256,"MQREGO_INFORM_IF_RETAINED"),(512,"MQREGO_DUPLICATES_OK"),(1024,"MQREGO_NON_PERSISTENT"),(2048,"MQREGO_PERSISTENT"),(4096,"MQREGO_PERSISTENT_AS_PUBLISH"),(8192,"MQREGO_PERSISTENT_AS_Q"),(16384,"MQREGO_ADD_NAME"),(32768,"MQREGO_NO_ALTERATION"),(65536,"MQREGO_FULL_RESPONSE"),(131072,"MQREGO_JOIN_SHARED"),(262144,"MQREGO_JOIN_EXCLUSIVE"),(524288,"MQREGO_LEAVE_ONLY"),(1048576,"MQREGO_VARIABLE_USER_ID"),(2097152,"MQREGO_LOCKED"),], &[]);
pub const MQREORG_CONST: LinearSource = ConstSource(&[(0,"MQREORG_DISABLED"),(1,"MQREORG_ENABLED"),], &[]);
pub const MQRFH_CONST: LinearSource = ConstSource(&[(-65536,"MQRFH_FLAGS_RESTRICTED_MASK"),(0,"MQRFH_NONE"),], &[(0,"MQRFH_NO_FLAGS"),]);
pub const MQRL_CONST: LinearSource = ConstSource(&[(-1,"MQRL_UNDEFINED"),], &[]);
pub const MQRMHF_CONST: LinearSource = ConstSource(&[(0,"MQRMHF_NOT_LAST"),(1,"MQRMHF_LAST"),], &[]);
pub const MQROUTE_CONST: LinearSource = ConstSource(&[(-65536,"MQROUTE_DELIVER_REJ_UNSUP_MASK"),(0,"MQROUTE_UNLIMITED_ACTIVITIES"),(2,"MQROUTE_DETAIL_LOW"),(8,"MQROUTE_DETAIL_MEDIUM"),(32,"MQROUTE_DETAIL_HIGH"),(256,"MQROUTE_FORWARD_ALL"),(512,"MQROUTE_FORWARD_IF_SUPPORTED"),(4096,"MQROUTE_DELIVER_YES"),(8192,"MQROUTE_DELIVER_NO"),(65539,"MQROUTE_ACCUMULATE_NONE"),(65540,"MQROUTE_ACCUMULATE_IN_MSG"),(65541,"MQROUTE_ACCUMULATE_AND_REPLY"),], &[(-65536,"MQROUTE_FORWARD_REJ_UNSUP_MASK"),]);
pub const MQRO_CONST: LinearSource = ConstSource(&[(-270532353,"MQRO_ACCEPT_UNSUP_MASK"),(0,"MQRO_NONE"),(1,"MQRO_PAN"),(2,"MQRO_NAN"),(4,"MQRO_ACTIVITY"),(64,"MQRO_PASS_CORREL_ID"),(128,"MQRO_PASS_MSG_ID"),(256,"MQRO_COA"),(768,"MQRO_COA_WITH_DATA"),(1792,"MQRO_COA_WITH_FULL_DATA"),(2048,"MQRO_COD"),(6144,"MQRO_COD_WITH_DATA"),(14336,"MQRO_COD_WITH_FULL_DATA"),(16384,"MQRO_PASS_DISCARD_AND_EXPIRY"),(261888,"MQRO_ACCEPT_UNSUP_IF_XMIT_MASK"),(2097152,"MQRO_EXPIRATION"),(6291456,"MQRO_EXPIRATION_WITH_DATA"),(14680064,"MQRO_EXPIRATION_WITH_FULL_DATA"),(16777216,"MQRO_EXCEPTION"),(50331648,"MQRO_EXCEPTION_WITH_DATA"),(117440512,"MQRO_EXCEPTION_WITH_FULL_DATA"),(134217728,"MQRO_DISCARD_MSG"),(270270464,"MQRO_REJECT_UNSUP_MASK"),], &[(0,"MQRO_COPY_MSG_ID_TO_CORREL_ID"),(0,"MQRO_DEAD_LETTER_Q"),(0,"MQRO_NEW_MSG_ID"),]);
pub const MQRP_CONST: LinearSource = ConstSource(&[(0,"MQRP_NO"),(1,"MQRP_YES"),], &[]);
pub const MQRQ_CONST: LinearSource = ConstSource(&[(1,"MQRQ_CONN_NOT_AUTHORIZED"),(2,"MQRQ_OPEN_NOT_AUTHORIZED"),(3,"MQRQ_CLOSE_NOT_AUTHORIZED"),(4,"MQRQ_CMD_NOT_AUTHORIZED"),(5,"MQRQ_Q_MGR_STOPPING"),(6,"MQRQ_Q_MGR_QUIESCING"),(7,"MQRQ_CHANNEL_STOPPED_OK"),(8,"MQRQ_CHANNEL_STOPPED_ERROR"),(9,"MQRQ_CHANNEL_STOPPED_RETRY"),(10,"MQRQ_CHANNEL_STOPPED_DISABLED"),(11,"MQRQ_BRIDGE_STOPPED_OK"),(12,"MQRQ_BRIDGE_STOPPED_ERROR"),(13,"MQRQ_SSL_HANDSHAKE_ERROR"),(14,"MQRQ_SSL_CIPHER_SPEC_ERROR"),(15,"MQRQ_SSL_CLIENT_AUTH_ERROR"),(16,"MQRQ_SSL_PEER_NAME_ERROR"),(17,"MQRQ_SUB_NOT_AUTHORIZED"),(18,"MQRQ_SUB_DEST_NOT_AUTHORIZED"),(19,"MQRQ_SSL_UNKNOWN_REVOCATION"),(20,"MQRQ_SYS_CONN_NOT_AUTHORIZED"),(21,"MQRQ_CHANNEL_BLOCKED_ADDRESS"),(22,"MQRQ_CHANNEL_BLOCKED_USERID"),(23,"MQRQ_CHANNEL_BLOCKED_NOACCESS"),(24,"MQRQ_MAX_ACTIVE_CHANNELS"),(25,"MQRQ_MAX_CHANNELS"),(26,"MQRQ_SVRCONN_INST_LIMIT"),(27,"MQRQ_CLIENT_INST_LIMIT"),(28,"MQRQ_CAF_NOT_INSTALLED"),(29,"MQRQ_CSP_NOT_AUTHORIZED"),(30,"MQRQ_FAILOVER_PERMITTED"),(31,"MQRQ_FAILOVER_NOT_PERMITTED"),(32,"MQRQ_STANDBY_ACTIVATED"),(33,"MQRQ_REPLICA_ACTIVATED"),], &[]);
pub const MQRT_CONST: LinearSource = ConstSource(&[(1,"MQRT_CONFIGURATION"),(2,"MQRT_EXPIRY"),(3,"MQRT_NSPROC"),(4,"MQRT_PROXYSUB"),(5,"MQRT_SUB_CONFIGURATION"),], &[]);
pub const MQRU_CONST: LinearSource = ConstSource(&[(1,"MQRU_PUBLISH_ON_REQUEST"),(2,"MQRU_PUBLISH_ALL"),], &[]);
pub const MQSCA_CONST: LinearSource = ConstSource(&[(0,"MQSCA_REQUIRED"),(1,"MQSCA_OPTIONAL"),(2,"MQSCA_NEVER_REQUIRED"),], &[]);
pub const MQSCOPE_CONST: LinearSource = ConstSource(&[(0,"MQSCOPE_ALL"),(1,"MQSCOPE_AS_PARENT"),(4,"MQSCOPE_QMGR"),], &[]);
pub const MQSCO_CONST: LinearSource = ConstSource(&[(1,"MQSCO_Q_MGR"),(2,"MQSCO_CELL"),], &[(0,"MQSCO_RESET_COUNT_DEFAULT"),]);
pub const MQSCYC_CONST: LinearSource = ConstSource(&[(0,"MQSCYC_UPPER"),(1,"MQSCYC_MIXED"),], &[]);
pub const MQSECCOMM_CONST: LinearSource = ConstSource(&[(0,"MQSECCOMM_NO"),(1,"MQSECCOMM_YES"),(2,"MQSECCOMM_ANON"),], &[]);
pub const MQSECITEM_CONST: LinearSource = ConstSource(&[(0,"MQSECITEM_ALL"),(1,"MQSECITEM_MQADMIN"),(2,"MQSECITEM_MQNLIST"),(3,"MQSECITEM_MQPROC"),(4,"MQSECITEM_MQQUEUE"),(5,"MQSECITEM_MQCONN"),(6,"MQSECITEM_MQCMDS"),(7,"MQSECITEM_MXADMIN"),(8,"MQSECITEM_MXNLIST"),(9,"MQSECITEM_MXPROC"),(10,"MQSECITEM_MXQUEUE"),(11,"MQSECITEM_MXTOPIC"),], &[]);
pub const MQSECPROT_CONST: LinearSource = ConstSource(&[(0,"MQSECPROT_NONE"),(1,"MQSECPROT_SSLV30"),(2,"MQSECPROT_TLSV10"),(4,"MQSECPROT_TLSV12"),(8,"MQSECPROT_TLSV13"),], &[]);
pub const MQSECSW_CONST: LinearSource = ConstSource(&[(1,"MQSECSW_PROCESS"),(2,"MQSECSW_NAMELIST"),(3,"MQSECSW_Q"),(4,"MQSECSW_TOPIC"),(6,"MQSECSW_CONTEXT"),(7,"MQSECSW_ALTERNATE_USER"),(8,"MQSECSW_COMMAND"),(9,"MQSECSW_CONNECTION"),(10,"MQSECSW_SUBSYSTEM"),(11,"MQSECSW_COMMAND_RESOURCES"),(15,"MQSECSW_Q_MGR"),(16,"MQSECSW_QSG"),(21,"MQSECSW_OFF_FOUND"),(22,"MQSECSW_ON_FOUND"),(23,"MQSECSW_OFF_NOT_FOUND"),(24,"MQSECSW_ON_NOT_FOUND"),(25,"MQSECSW_OFF_ERROR"),(26,"MQSECSW_ON_OVERRIDDEN"),], &[]);
pub const MQSECTYPE_CONST: LinearSource = ConstSource(&[(1,"MQSECTYPE_AUTHSERV"),(2,"MQSECTYPE_SSL"),(3,"MQSECTYPE_CLASSES"),(4,"MQSECTYPE_CONNAUTH"),], &[]);
pub const MQSELTYPE_CONST: LinearSource = ConstSource(&[(0,"MQSELTYPE_NONE"),(1,"MQSELTYPE_STANDARD"),(2,"MQSELTYPE_EXTENDED"),], &[]);
pub const MQSEL_ALL_CONST: LinearSource = ConstSource(&[(-30003,"MQSEL_ALL_SYSTEM_SELECTORS"),(-30002,"MQSEL_ALL_USER_SELECTORS"),(-30001,"MQSEL_ALL_SELECTORS"),], &[]);
pub const MQSEL_ANY_CONST: LinearSource = ConstSource(&[(-30003,"MQSEL_ANY_SYSTEM_SELECTOR"),(-30002,"MQSEL_ANY_USER_SELECTOR"),(-30001,"MQSEL_ANY_SELECTOR"),], &[]);
pub const MQSMPO_CONST: LinearSource = ConstSource(&[(0,"MQSMPO_NONE"),(1,"MQSMPO_SET_PROP_UNDER_CURSOR"),(2,"MQSMPO_SET_PROP_AFTER_CURSOR"),(4,"MQSMPO_APPEND_PROPERTY"),(8,"MQSMPO_SET_PROP_BEFORE_CURSOR"),], &[]);
pub const MQSO_CONST: LinearSource = ConstSource(&[(0,"MQSO_NONE"),(1,"MQSO_ALTER"),(2,"MQSO_CREATE"),(4,"MQSO_RESUME"),(8,"MQSO_DURABLE"),(16,"MQSO_GROUP_SUB"),(32,"MQSO_MANAGED"),(64,"MQSO_SET_IDENTITY_CONTEXT"),(128,"MQSO_NO_MULTICAST"),(256,"MQSO_FIXED_USERID"),(512,"MQSO_ANY_USERID"),(2048,"MQSO_PUBLICATIONS_ON_REQUEST"),(4096,"MQSO_NEW_PUBLICATIONS_ONLY"),(8192,"MQSO_FAIL_IF_QUIESCING"),(262144,"MQSO_ALTERNATE_USER_AUTHORITY"),(1048576,"MQSO_WILDCARD_CHAR"),(2097152,"MQSO_WILDCARD_TOPIC"),(4194304,"MQSO_SET_CORREL_ID"),(67108864,"MQSO_SCOPE_QMGR"),(134217728,"MQSO_NO_READ_AHEAD"),(268435456,"MQSO_READ_AHEAD"),], &[(0,"MQSO_NON_DURABLE"),(0,"MQSO_READ_AHEAD_AS_Q_DEF"),]);
pub const MQSPL_CONST: LinearSource = ConstSource(&[(0,"MQSPL_PASSTHRU"),(1,"MQSPL_REMOVE"),(2,"MQSPL_AS_POLICY"),], &[]);
pub const MQSP_CONST: LinearSource = ConstSource(&[(0,"MQSP_NOT_AVAILABLE"),(1,"MQSP_AVAILABLE"),], &[]);
pub const MQSQQM_CONST: LinearSource = ConstSource(&[(0,"MQSQQM_USE"),(1,"MQSQQM_IGNORE"),], &[]);
pub const MQSRO_CONST: LinearSource = ConstSource(&[(0,"MQSRO_NONE"),(8192,"MQSRO_FAIL_IF_QUIESCING"),], &[]);
pub const MQSR_CONST: LinearSource = ConstSource(&[(1,"MQSR_ACTION_PUBLICATION"),], &[]);
pub const MQSSL_CONST: LinearSource = ConstSource(&[(0,"MQSSL_FIPS_NO"),(1,"MQSSL_FIPS_YES"),], &[]);
pub const MQSTAT_CONST: LinearSource = ConstSource(&[(0,"MQSTAT_TYPE_ASYNC_ERROR"),(1,"MQSTAT_TYPE_RECONNECTION"),(2,"MQSTAT_TYPE_RECONNECTION_ERROR"),], &[]);
pub const MQSTDBY_CONST: LinearSource = ConstSource(&[(0,"MQSTDBY_NOT_PERMITTED"),(1,"MQSTDBY_PERMITTED"),], &[]);
pub const MQST_CONST: LinearSource = ConstSource(&[(0,"MQST_BEST_EFFORT"),(1,"MQST_MUST_DUP"),], &[]);
pub const MQSUBTYPE_CONST: LinearSource = ConstSource(&[(-2,"MQSUBTYPE_USER"),(-1,"MQSUBTYPE_ALL"),(1,"MQSUBTYPE_API"),(2,"MQSUBTYPE_ADMIN"),(3,"MQSUBTYPE_PROXY"),], &[]);
pub const MQSUB_CONST: LinearSource = ConstSource(&[(0,"MQSUB_DURABLE_AS_PARENT"),(1,"MQSUB_DURABLE_ALLOWED"),(2,"MQSUB_DURABLE_INHIBITED"),], &[]);
pub const MQSUB_DURABILITY_CONST: LinearSource = ConstSource(&[(-1,"MQSUB_DURABLE_ALL"),(1,"MQSUB_DURABLE_YES"),(2,"MQSUB_DURABLE_NO"),], &[]);
pub const MQSUS_CONST: LinearSource = ConstSource(&[(0,"MQSUS_NO"),(1,"MQSUS_YES"),], &[]);
pub const MQSVC_CONTROL_CONST: LinearSource = ConstSource(&[(0,"MQSVC_CONTROL_Q_MGR"),(1,"MQSVC_CONTROL_Q_MGR_START"),(2,"MQSVC_CONTROL_MANUAL"),], &[]);
pub const MQSVC_STATUS_CONST: LinearSource = ConstSource(&[(0,"MQSVC_STATUS_STOPPED"),(1,"MQSVC_STATUS_STARTING"),(2,"MQSVC_STATUS_RUNNING"),(3,"MQSVC_STATUS_STOPPING"),(4,"MQSVC_STATUS_RETRYING"),], &[]);
pub const MQSVC_TYPE_CONST: LinearSource = ConstSource(&[(0,"MQSVC_TYPE_COMMAND"),(1,"MQSVC_TYPE_SERVER"),], &[]);
pub const MQSYNCPOINT_CONST: LinearSource = ConstSource(&[(0,"MQSYNCPOINT_YES"),(1,"MQSYNCPOINT_IFPER"),], &[]);
pub const MQSYSOBJ_CONST: LinearSource = ConstSource(&[(0,"MQSYSOBJ_YES"),(1,"MQSYSOBJ_NO"),], &[]);
pub const MQSYSP_CONST: LinearSource = ConstSource(&[(0,"MQSYSP_NO"),(1,"MQSYSP_YES"),(2,"MQSYSP_EXTENDED"),(10,"MQSYSP_TYPE_INITIAL"),(11,"MQSYSP_TYPE_SET"),(12,"MQSYSP_TYPE_LOG_COPY"),(13,"MQSYSP_TYPE_LOG_STATUS"),(14,"MQSYSP_TYPE_ARCHIVE_TAPE"),(20,"MQSYSP_ALLOC_BLK"),(21,"MQSYSP_ALLOC_TRK"),(22,"MQSYSP_ALLOC_CYL"),(30,"MQSYSP_STATUS_BUSY"),(31,"MQSYSP_STATUS_PREMOUNT"),(32,"MQSYSP_STATUS_AVAILABLE"),(33,"MQSYSP_STATUS_UNKNOWN"),(34,"MQSYSP_STATUS_ALLOC_ARCHIVE"),(35,"MQSYSP_STATUS_COPYING_BSDS"),(36,"MQSYSP_STATUS_COPYING_LOG"),], &[]);
pub const MQS_AVAIL_CONST: LinearSource = ConstSource(&[(0,"MQS_AVAIL_NORMAL"),(1,"MQS_AVAIL_ERROR"),(2,"MQS_AVAIL_STOPPED"),], &[]);
pub const MQS_EXPANDST_CONST: LinearSource = ConstSource(&[(0,"MQS_EXPANDST_NORMAL"),(1,"MQS_EXPANDST_FAILED"),(2,"MQS_EXPANDST_MAXIMUM"),], &[]);
pub const MQS_OPENMODE_CONST: LinearSource = ConstSource(&[(0,"MQS_OPENMODE_NONE"),(1,"MQS_OPENMODE_READONLY"),(2,"MQS_OPENMODE_UPDATE"),(3,"MQS_OPENMODE_RECOVERY"),], &[]);
pub const MQS_STATUS_CONST: LinearSource = ConstSource(&[(0,"MQS_STATUS_CLOSED"),(1,"MQS_STATUS_CLOSING"),(2,"MQS_STATUS_OPENING"),(3,"MQS_STATUS_OPEN"),(4,"MQS_STATUS_NOTENABLED"),(5,"MQS_STATUS_ALLOCFAIL"),(6,"MQS_STATUS_OPENFAIL"),(7,"MQS_STATUS_STGFAIL"),(8,"MQS_STATUS_DATAFAIL"),], &[]);
pub const MQTA_CONST: LinearSource = ConstSource(&[(1,"MQTA_BLOCK"),(2,"MQTA_PASSTHRU"),], &[]);
pub const MQTA_PROXY_CONST: LinearSource = ConstSource(&[(1,"MQTA_PROXY_SUB_FORCE"),(2,"MQTA_PROXY_SUB_FIRSTUSE"),], &[]);
pub const MQTA_PUB_CONST: LinearSource = ConstSource(&[(0,"MQTA_PUB_AS_PARENT"),(1,"MQTA_PUB_INHIBITED"),(2,"MQTA_PUB_ALLOWED"),], &[]);
pub const MQTA_SUB_CONST: LinearSource = ConstSource(&[(0,"MQTA_SUB_AS_PARENT"),(1,"MQTA_SUB_INHIBITED"),(2,"MQTA_SUB_ALLOWED"),], &[]);
pub const MQTCPKEEP_CONST: LinearSource = ConstSource(&[(0,"MQTCPKEEP_NO"),(1,"MQTCPKEEP_YES"),], &[]);
pub const MQTCPSTACK_CONST: LinearSource = ConstSource(&[(0,"MQTCPSTACK_SINGLE"),(1,"MQTCPSTACK_MULTIPLE"),], &[]);
pub const MQTC_CONST: LinearSource = ConstSource(&[(0,"MQTC_OFF"),(1,"MQTC_ON"),], &[]);
pub const MQTIME_CONST: LinearSource = ConstSource(&[(0,"MQTIME_UNIT_MINS"),(1,"MQTIME_UNIT_SECS"),], &[]);
pub const MQTOPT_CONST: LinearSource = ConstSource(&[(0,"MQTOPT_LOCAL"),(1,"MQTOPT_CLUSTER"),(2,"MQTOPT_ALL"),], &[]);
pub const MQTRAXSTR_CONST: LinearSource = ConstSource(&[(0,"MQTRAXSTR_NO"),(1,"MQTRAXSTR_YES"),], &[]);
pub const MQTRIGGER_CONST: LinearSource = ConstSource(&[(0,"MQTRIGGER_RESTART_NO"),(1,"MQTRIGGER_RESTART_YES"),], &[]);
pub const MQTSCOPE_CONST: LinearSource = ConstSource(&[(1,"MQTSCOPE_QMGR"),(2,"MQTSCOPE_ALL"),], &[]);
pub const MQTT_CONST: LinearSource = ConstSource(&[(0,"MQTT_NONE"),(1,"MQTT_FIRST"),(2,"MQTT_EVERY"),(3,"MQTT_DEPTH"),], &[]);
pub const MQTYPE_CONST: LinearSource = ConstSource(&[(0,"MQTYPE_AS_SET"),(2,"MQTYPE_NULL"),(4,"MQTYPE_BOOLEAN"),(8,"MQTYPE_BYTE_STRING"),(16,"MQTYPE_INT8"),(32,"MQTYPE_INT16"),(64,"MQTYPE_INT32"),(128,"MQTYPE_INT64"),(256,"MQTYPE_FLOAT32"),(512,"MQTYPE_FLOAT64"),(1024,"MQTYPE_STRING"),], &[(64,"MQTYPE_LONG"),]);
pub const MQUCI_CONST: LinearSource = ConstSource(&[(0,"MQUCI_NO"),(1,"MQUCI_YES"),], &[]);
pub const MQUIDSUPP_CONST: LinearSource = ConstSource(&[(0,"MQUIDSUPP_NO"),(1,"MQUIDSUPP_YES"),], &[]);
pub const MQUNDELIVERED_CONST: LinearSource = ConstSource(&[(0,"MQUNDELIVERED_NORMAL"),(1,"MQUNDELIVERED_SAFE"),(2,"MQUNDELIVERED_DISCARD"),(3,"MQUNDELIVERED_KEEP"),], &[]);
pub const MQUOWST_CONST: LinearSource = ConstSource(&[(0,"MQUOWST_NONE"),(1,"MQUOWST_ACTIVE"),(2,"MQUOWST_PREPARED"),(3,"MQUOWST_UNRESOLVED"),], &[]);
pub const MQUOWT_CONST: LinearSource = ConstSource(&[(0,"MQUOWT_Q_MGR"),(1,"MQUOWT_CICS"),(2,"MQUOWT_RRS"),(3,"MQUOWT_IMS"),(4,"MQUOWT_XA"),], &[]);
pub const MQUSAGE_DS_CONST: LinearSource = ConstSource(&[(10,"MQUSAGE_DS_OLDEST_ACTIVE_UOW"),(11,"MQUSAGE_DS_OLDEST_PS_RECOVERY"),(12,"MQUSAGE_DS_OLDEST_CF_RECOVERY"),], &[]);
pub const MQUSAGE_EXPAND_CONST: LinearSource = ConstSource(&[(1,"MQUSAGE_EXPAND_USER"),(2,"MQUSAGE_EXPAND_SYSTEM"),(3,"MQUSAGE_EXPAND_NONE"),], &[]);
pub const MQUSAGE_PS_CONST: LinearSource = ConstSource(&[(0,"MQUSAGE_PS_AVAILABLE"),(1,"MQUSAGE_PS_DEFINED"),(2,"MQUSAGE_PS_OFFLINE"),(3,"MQUSAGE_PS_NOT_DEFINED"),(4,"MQUSAGE_PS_SUSPENDED"),], &[]);
pub const MQUSAGE_SMDS_CONST: LinearSource = ConstSource(&[(0,"MQUSAGE_SMDS_AVAILABLE"),(1,"MQUSAGE_SMDS_NO_DATA"),], &[]);
pub const MQUSEDLQ_CONST: LinearSource = ConstSource(&[(0,"MQUSEDLQ_AS_PARENT"),(1,"MQUSEDLQ_NO"),(2,"MQUSEDLQ_YES"),], &[]);
pub const MQUSRC_CONST: LinearSource = ConstSource(&[(0,"MQUSRC_MAP"),(1,"MQUSRC_NOACCESS"),(2,"MQUSRC_CHANNEL"),], &[]);
pub const MQUS_CONST: LinearSource = ConstSource(&[(0,"MQUS_NORMAL"),(1,"MQUS_TRANSMISSION"),], &[]);
pub const MQVL_CONST: LinearSource = ConstSource(&[(-1,"MQVL_NULL_TERMINATED"),(0,"MQVL_EMPTY_STRING"),], &[]);
pub const MQVS_CONST: LinearSource = ConstSource(&[(-1,"MQVS_NULL_TERMINATED"),], &[]);
pub const MQVU_CONST: LinearSource = ConstSource(&[(1,"MQVU_FIXED_USER"),(2,"MQVU_ANY_USER"),], &[]);
pub const MQWARN_CONST: LinearSource = ConstSource(&[(0,"MQWARN_NO"),(1,"MQWARN_YES"),], &[]);
...
pub const MQWS_CONST: LinearSource = ConstSource(&[(0,"MQWS_DEFAULT"),(1,"MQWS_CHAR"),(2,"MQWS_TOPIC"),], &[]);
pub const MQWXP_CONST: LinearSource = ConstSource(&[(2,"MQWXP_PUT_BY_CLUSTER_CHL"),], &[]);
pub const MQXACT_CONST: LinearSource = ConstSource(&[(1,"MQXACT_EXTERNAL"),(2,"MQXACT_INTERNAL"),], &[]);
pub const MQXCC_CONST: LinearSource = ConstSource(&[(-8,"MQXCC_FAILED"),(-7,"MQXCC_REQUEST_ACK"),(-6,"MQXCC_CLOSE_CHANNEL"),(-5,"MQXCC_SUPPRESS_EXIT"),(-4,"MQXCC_SEND_SEC_MSG"),(-3,"MQXCC_SEND_AND_REQUEST_SEC_MSG"),(-2,"MQXCC_SKIP_FUNCTION"),(-1,"MQXCC_SUPPRESS_FUNCTION"),(0,"MQXCC_OK"),], &[]);
pub const MQXC_CONST: LinearSource = ConstSource(&[(1,"MQXC_MQOPEN"),(2,"MQXC_MQCLOSE"),(3,"MQXC_MQGET"),(4,"MQXC_MQPUT"),(5,"MQXC_MQPUT1"),(6,"MQXC_MQINQ"),(8,"MQXC_MQSET"),(9,"MQXC_MQBACK"),(10,"MQXC_MQCMIT"),(42,"MQXC_MQSUB"),(43,"MQXC_MQSUBRQ"),(44,"MQXC_MQCB"),(45,"MQXC_MQCTL"),(46,"MQXC_MQSTAT"),(48,"MQXC_CALLBACK"),], &[]);
pub const MQXDR_CONST: LinearSource = ConstSource(&[(0,"MQXDR_OK"),(1,"MQXDR_CONVERSION_FAILED"),], &[]);
pub const MQXEPO_CONST: LinearSource = ConstSource(&[(0,"MQXEPO_NONE"),], &[]);
pub const MQXE_CONST: LinearSource = ConstSource(&[(0,"MQXE_OTHER"),(1,"MQXE_MCA"),(2,"MQXE_MCA_SVRCONN"),(3,"MQXE_COMMAND_SERVER"),(4,"MQXE_MQSC"),(5,"MQXE_MCA_CLNTCONN"),], &[]);
pub const MQXF_CONST: LinearSource = ConstSource(&[(1,"MQXF_INIT"),(2,"MQXF_TERM"),(3,"MQXF_CONN"),(4,"MQXF_CONNX"),(5,"MQXF_DISC"),(6,"MQXF_OPEN"),(7,"MQXF_CLOSE"),(8,"MQXF_PUT1"),(9,"MQXF_PUT"),(10,"MQXF_GET"),(11,"MQXF_DATA_CONV_ON_GET"),(12,"MQXF_INQ"),(13,"MQXF_SET"),(14,"MQXF_BEGIN"),(15,"MQXF_CMIT"),(16,"MQXF_BACK"),(18,"MQXF_STAT"),(19,"MQXF_CB"),(20,"MQXF_CTL"),(21,"MQXF_CALLBACK"),(22,"MQXF_SUB"),(23,"MQXF_SUBRQ"),(24,"MQXF_XACLOSE"),(25,"MQXF_XACOMMIT"),(26,"MQXF_XACOMPLETE"),(27,"MQXF_XAEND"),(28,"MQXF_XAFORGET"),(29,"MQXF_XAOPEN"),(30,"MQXF_XAPREPARE"),(31,"MQXF_XARECOVER"),(32,"MQXF_XAROLLBACK"),(33,"MQXF_XASTART"),(34,"MQXF_AXREG"),(35,"MQXF_AXUNREG"),], &[]);
pub const MQXPT_CONST: LinearSource = ConstSource(&[(-1,"MQXPT_ALL"),(0,"MQXPT_LOCAL"),(1,"MQXPT_LU62"),(2,"MQXPT_TCP"),(3,"MQXPT_NETBIOS"),(4,"MQXPT_SPX"),(5,"MQXPT_DECNET"),(6,"MQXPT_UDP"),], &[]);
pub const MQXR2_CONST: LinearSource = ConstSource(&[(0,"MQXR2_DEFAULT_CONTINUATION"),(1,"MQXR2_PUT_WITH_DEF_USERID"),(2,"MQXR2_PUT_WITH_MSG_USERID"),(4,"MQXR2_USE_EXIT_BUFFER"),(8,"MQXR2_CONTINUE_CHAIN"),(16,"MQXR2_SUPPRESS_CHAIN"),(32,"MQXR2_DYNAMIC_CACHE"),], &[(0,"MQXR2_PUT_WITH_DEF_ACTION"),(0,"MQXR2_STATIC_CACHE"),(0,"MQXR2_USE_AGENT_BUFFER"),]);
pub const MQXR_CONST: LinearSource = ConstSource(&[(1,"MQXR_BEFORE"),(2,"MQXR_AFTER"),(3,"MQXR_CONNECTION"),(4,"MQXR_BEFORE_CONVERT"),(11,"MQXR_INIT"),(12,"MQXR_TERM"),(13,"MQXR_MSG"),(14,"MQXR_XMIT"),(15,"MQXR_SEC_MSG"),(16,"MQXR_INIT_SEC"),(17,"MQXR_RETRY"),(18,"MQXR_AUTO_CLUSSDR"),(19,"MQXR_AUTO_RECEIVER"),(20,"MQXR_CLWL_OPEN"),(21,"MQXR_CLWL_PUT"),(22,"MQXR_CLWL_MOVE"),(23,"MQXR_CLWL_REPOS"),(24,"MQXR_CLWL_REPOS_MOVE"),(25,"MQXR_END_BATCH"),(26,"MQXR_ACK_RECEIVED"),(27,"MQXR_AUTO_SVRCONN"),(28,"MQXR_AUTO_CLUSRCVR"),(29,"MQXR_SEC_PARMS"),(30,"MQXR_PUBLICATION"),(31,"MQXR_PRECONNECT"),], &[]);
pub const MQXT_CONST: LinearSource = ConstSource(&[(1,"MQXT_API_CROSSING_EXIT"),(2,"MQXT_API_EXIT"),(11,"MQXT_CHANNEL_SEC_EXIT"),(12,"MQXT_CHANNEL_MSG_EXIT"),(13,"MQXT_CHANNEL_SEND_EXIT"),(14,"MQXT_CHANNEL_RCV_EXIT"),(15,"MQXT_CHANNEL_MSG_RETRY_EXIT"),(16,"MQXT_CHANNEL_AUTO_DEF_EXIT"),(20,"MQXT_CLUSTER_WORKLOAD_EXIT"),(21,"MQXT_PUBSUB_ROUTING_EXIT"),(22,"MQXT_PUBLISH_EXIT"),(23,"MQXT_PRECONNECT_EXIT"),], &[]);
pub const MQZAET_CONST: LinearSource = ConstSource(&[(0,"MQZAET_NONE"),(1,"MQZAET_PRINCIPAL"),(2,"MQZAET_GROUP"),(3,"MQZAET_UNKNOWN"),], &[]);
pub const MQZAO_CONST: LinearSource = ConstSource(&[(0,"MQZAO_NONE"),(1,"MQZAO_CONNECT"),(2,"MQZAO_BROWSE"),(4,"MQZAO_INPUT"),(8,"MQZAO_OUTPUT"),(16,"MQZAO_INQUIRE"),(32,"MQZAO_SET"),(64,"MQZAO_PASS_IDENTITY_CONTEXT"),(128,"MQZAO_PASS_ALL_CONTEXT"),(256,"MQZAO_SET_IDENTITY_CONTEXT"),(512,"MQZAO_SET_ALL_CONTEXT"),(1024,"MQZAO_ALTERNATE_USER_AUTHORITY"),(2048,"MQZAO_PUBLISH"),(4096,"MQZAO_SUBSCRIBE"),(8192,"MQZAO_RESUME"),(16383,"MQZAO_ALL_MQI"),(65536,"MQZAO_CREATE"),(131072,"MQZAO_DELETE"),(262144,"MQZAO_DISPLAY"),(524288,"MQZAO_CHANGE"),(1048576,"MQZAO_CLEAR"),(2097152,"MQZAO_CONTROL"),(4194304,"MQZAO_CONTROL_EXTENDED"),(8388608,"MQZAO_AUTHORIZE"),(16646144,"MQZAO_ALL_ADMIN"),(16777216,"MQZAO_REMOVE"),(33554432,"MQZAO_SYSTEM"),(50216959,"MQZAO_ALL"),(67108864,"MQZAO_CREATE_ONLY"),], &[]);
pub const MQZAT_CONST: LinearSource = ConstSource(&[(0,"MQZAT_INITIAL_CONTEXT"),(1,"MQZAT_CHANGE_CONTEXT"),], &[]);
pub const MQZCI_CONST: LinearSource = ConstSource(&[(0,"MQZCI_CONTINUE"),(1,"MQZCI_STOP"),], &[(0,"MQZCI_DEFAULT"),]);
pub const MQZID_CONST: LinearSource = ConstSource(&[(0,"MQZID_INIT"),(1,"MQZID_TERM"),], &[]);
pub const MQZID_AUTHORITY_CONST: LinearSource = ConstSource(&[(0,"MQZID_INIT_AUTHORITY"),(1,"MQZID_TERM_AUTHORITY"),(2,"MQZID_CHECK_AUTHORITY"),(3,"MQZID_COPY_ALL_AUTHORITY"),(4,"MQZID_DELETE_AUTHORITY"),(5,"MQZID_SET_AUTHORITY"),(6,"MQZID_GET_AUTHORITY"),(7,"MQZID_GET_EXPLICIT_AUTHORITY"),(8,"MQZID_REFRESH_CACHE"),(9,"MQZID_ENUMERATE_AUTHORITY_DATA"),(10,"MQZID_AUTHENTICATE_USER"),(11,"MQZID_FREE_USER"),(12,"MQZID_INQUIRE"),(13,"MQZID_CHECK_PRIVILEGED"),], &[]);
pub const MQZID_NAME_CONST: LinearSource = ConstSource(&[(0,"MQZID_INIT_NAME"),(1,"MQZID_TERM_NAME"),(2,"MQZID_LOOKUP_NAME"),(3,"MQZID_INSERT_NAME"),(4,"MQZID_DELETE_NAME"),], &[]);
pub const MQZID_USERID_CONST: LinearSource = ConstSource(&[(0,"MQZID_INIT_USERID"),(1,"MQZID_TERM_USERID"),(2,"MQZID_FIND_USERID"),], &[]);
pub const MQZIO_CONST: LinearSource = ConstSource(&[(0,"MQZIO_PRIMARY"),(1,"MQZIO_SECONDARY"),], &[]);
pub const MQZSE_CONST: LinearSource = ConstSource(&[(0,"MQZSE_CONTINUE"),(1,"MQZSE_START"),], &[]);
pub const MQZSL_CONST: LinearSource = ConstSource(&[(0,"MQZSL_NOT_RETURNED"),(1,"MQZSL_RETURNED"),], &[]);
pub const MQZTO_CONST: LinearSource = ConstSource(&[(0,"MQZTO_PRIMARY"),(1,"MQZTO_SECONDARY"),], &[]);
pub const MQ_CERT_CONST: LinearSource = ConstSource(&[(0,"MQ_CERT_VAL_POLICY_ANY"),(1,"MQ_CERT_VAL_POLICY_RFC5280"),(2,"MQ_CERT_VAL_POLICY_NONE"),], &[(0,"MQ_CERT_VAL_POLICY_DEFAULT"),]);
pub const MQ_HTTPSCERTREV_CONST: LinearSource = ConstSource(&[(0,"MQ_HTTPSCERTREV_DEFAULT"),(1,"MQ_HTTPSCERTREV_REQUIRED"),(2,"MQ_HTTPSCERTREV_DISABLED"),(3,"MQ_HTTPSCERTREV_OPTIONAL"),], &[]);
pub const MQ_HTTPSCERTVAL_CONST: LinearSource = ConstSource(&[(0,"MQ_HTTPSCERTVAL_DEFAULT"),(1,"MQ_HTTPSCERTVAL_ANY"),(2,"MQ_HTTPSCERTVAL_NONE"),(3,"MQ_HTTPSCERTVAL_HOSTNAMECN"),], &[]);
pub const MQ_MQTT_CONST: LinearSource = ConstSource(&[(65536,"MQ_MQTT_MAX_KEEP_ALIVE"),], &[]);
pub const MQ_SUITE_CONST: LinearSource = ConstSource(&[(0,"MQ_SUITE_B_NOT_AVAILABLE"),(1,"MQ_SUITE_B_NONE"),(2,"MQ_SUITE_B_128_BIT"),(4,"MQ_SUITE_B_192_BIT"),], &[(4,"MQ_SUITE_B_SIZE"),]);
